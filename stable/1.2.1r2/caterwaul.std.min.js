...
return new $.syntax("()",new $.syntax(".",new $.syntax("(",object),fn),new $.syntax(",",xs,this(node[1])).unflatten())}};var postfix_function_template=qs7,postfix_function=$.rereplacer(qs8,function(match){return postfix_function_template.replace({_f:match._f,_x:this(match._x).flatten("/").with_data(",").unflatten()})
});var modified_literal_form=$.pattern(qs9),lookup_literal_modifier=function(caterwaul,type,modifier){var hash=caterwaul.literal_modifiers[type];return hash.hasOwnProperty(modifier)&&hash[modifier]
...
return caterwaul_function}});result.caterwaul_expression_ref_table={qs1:('new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_body" ) ) ) )'),qs2:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_regexp" ) ,new caterwaul.syntax( "exec" ) ) ,new caterwaul.syntax( "_" ) )')};
...
caterwaul.module("std.words",(function(qs1,qs2,qs3,qs4,qs5,qs6,qs7,qs8,qs9,qsa,qsb,qsc,qsd,qsf,qsg){var result=(function($){(function(){var scope_template=qs1;return($.words=function(caterwaul_function){return($.merge(caterwaul_function.modifiers,$.words.modifiers),$.merge(caterwaul_function.parameterized_modifiers,$.words.parameterized_modifiers),caterwaul_function)
...
},delay:$.reexpander(qs3),lazy:$.reexpander(qs4),capture:function(match){for(var comma=new $.syntax(","),bindings=match._expression.flatten(","),i=0,l=bindings.length;
...
}},$.words.parameterized_modifiers={given:$.reexpander(qs5),bgiven:$.reexpander(qs6),rescue:$.reexpander(qs7),se:$.reexpander(qs8),re:$.reexpander(qs9),then:$.reexpander(qsa),where:$.reexpander(qsb),using:$.reexpander(function(match){var m=this(match._parameters),o=$.compile(m),comma=new $.syntax(","),expression_ref=new $.expression_ref(m);
...
}return scope_template.replace({_variables:comma.unflatten(),_expression:match._expression})}),when:$.reexpander(qsc),and:$.reexpander(qsd),unless:$.reexpander(qsf),or:$.reexpander(qsg)})
}).call(this)});result.caterwaul_expression_ref_table={qs1:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_variables" ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "this" ) )'),qs2:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "this" ) )'),qs3:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "t" ) ,new caterwaul.syntax( "f" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "t" ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ) )'),qs4:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "t" ) ,new caterwaul.syntax( "f" ) ) ,new caterwaul.syntax( "v" ) ) ,new caterwaul.syntax( "vc" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "vc" ) ,new caterwaul.syntax( "v" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "vc" ) ,new caterwaul.syntax( "true" ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "v" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "t" ) ) ) ) ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ) )'),qs5:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_expression" ) ) ) ) )'),qs6:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "t" ) ,new caterwaul.syntax( "f" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "apply" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "t" ) ,new caterwaul.syntax( "arguments" ) ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ) )'),qs7:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "e" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "this" ) )'),qs8:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "it" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ,new caterwaul.syntax( "it" ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) )'),qs9:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "it" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) )'),qsa:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) )'),qsb:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_parameters" ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "this" ) )'),qsc:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) )'),qsd:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) )'),qsf:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ) )'),qsg:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "||" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_expression" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_parameters" ) ) ) )')};
return(result)}).call(this,new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("_variables")),new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("_expression"))))))),new caterwaul.syntax("call")),new caterwaul.syntax("this")),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("throw",new caterwaul.syntax("_expression"))))),new caterwaul.syntax("call")),new caterwaul.syntax("this")),new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax("t"),new caterwaul.syntax("f"))),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("f"),new caterwaul.syntax("call")),new caterwaul.syntax("t")))))))))),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_expression"))))))),new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("t"),new caterwaul.syntax("f")),new caterwaul.syntax("v")),new caterwaul.syntax("vc"))),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("?",new caterwaul.syntax("vc"),new caterwaul.syntax("v"),new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("vc"),new caterwaul.syntax("true")),new caterwaul.syntax("=",new caterwaul.syntax("v"),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("f"),new caterwaul.syntax("call")),new caterwaul.syntax("t")))))))))))))),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_expression"))))))),new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_parameters")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_expression"))))),new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax("t"),new caterwaul.syntax("f"))),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("f"),new caterwaul.syntax("apply")),new caterwaul.syntax(",",new caterwaul.syntax("t"),new caterwaul.syntax("arguments"))))))))))),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_parameters")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_expression"))))))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("_expression")))),new caterwaul.syntax("catch",new caterwaul.syntax("(",new caterwaul.syntax("e")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("_parameters"))))))))),new caterwaul.syntax("call")),new caterwaul.syntax("this")),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("it")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax(",",new caterwaul.syntax("(",new caterwaul.syntax("_parameters")),new caterwaul.syntax("it")))))),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("_expression")))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("it")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("_parameters")))))),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("_expression")))),new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax("(",new caterwaul.syntax("_expression")),new caterwaul.syntax("(",new caterwaul.syntax("_parameters")))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("("),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("_parameters")),new caterwaul.syntax("return",new caterwaul.syntax("(",new caterwaul.syntax("_expression"))))))),new caterwaul.syntax("call")),new caterwaul.syntax("this")),new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("_parameters")),new caterwaul.syntax("(",new caterwaul.syntax("_expression")))),new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("_expression")),new caterwaul.syntax("(",new caterwaul.syntax("_parameters")))),new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("u!",new caterwaul.syntax("(",new caterwaul.syntax("_parameters"))),new caterwaul.syntax("(",new caterwaul.syntax("_expression")))),new caterwaul.syntax("(",new caterwaul.syntax("||",new caterwaul.syntax("(",new caterwaul.syntax("_expression")),new caterwaul.syntax("(",new caterwaul.syntax("_parameters"))))));
caterwaul.module("std.seq",(function(qs,qs1,qs2,qs3,qs4,qs5,qs6,qs7,qs8,qs9,qsa,qsb,qsc,qsd,qse,qsf,qsg,qsh,qsi,qsj,qsk,qsl,qsm,qsn,qso,qsp,qsq,qsr,qss,qst,qsu,qsv,qsw,qsx,qsy,qsz,qs10,qs11,qs12,qs13,qs14,qs15,qs16,qs17,qs18,qs19,qs1a,qs1b,qs1c,qs1d,qs1e,qs1f,qs1g,qs1h,qs1i,qs1j,qs1k,qs1l,qs1m,qs1n,qs1o,qs1p,qs1q,qs1r,qs1s,qs1t,qs1u,qs1v,qs1w,qs1x,qs1y,qs1z,qs20,qs21,qs22,qs23,qs24,qs25,qs26,qs27,qs28,qs29,qs2a,qs2b,qs2c,qs2d,qs2e,qs2f,qs2g,qs2h,qs2i,qs2j,qs2k,qs2l,qs2m,qs2n,qs2o,qs2p,qs2q){var result1=(function($){(function(){var anon=$.anonymizer("S"),rule=function(p,e){return $.rereplacer(anon(p),e.constructor===$.syntax?anon(e):e)
},operator_macros=(function(){var loop_anon=$.anonymizer("x","y","i","j","l","lj","r","o","k"),scope=anon(qs),scoped=function(t){return scope.replace({_body:t})},form=function(x){return loop_anon(scoped(anon(x)))
},map=form(qs1),each=form(qs2),flatmap=form(qs3),iterate=form(qs4),filter=form(qs5),filter_not=form(qs6),map_filter=form(qs7),imap_filter=form(qs8),foldl=form(qs9),foldr=form(qsa),unfold=form(qsb),ifoldl=form(qsc),ifoldr=form(qsd),iunfold=form(qse),exists=form(qsf),not_exists=form(qsg),r_exists=form(qsh),concat=anon(qsi),kmap=form(qsj),keach=form(qsk),kfilter=form(qsl),kfilter_not=form(qsm),kmap_filter=form(qsn),vmap=form(qso),veach=form(qsp),vfilter=form(qsq),vfilter_not=form(qsr),vmap_filter=form(qss);
...
}};return(parse_modifiers(match._thing,use(forms.normal,forms.inormal),use(forms.bang,forms.ibang),use(forms.tbang,forms.itbang)))}).call(this)}},handle_map_forms=operator_case({normal:map,bang:each,tbang:flatmap,itbang:iterate}),handle_filter_forms=operator_case({normal:filter,bang:filter_not,tbang:map_filter,itbang:imap_filter}),handle_fold_forms=operator_case({normal:foldl,bang:foldr,tbang:unfold,inormal:ifoldl,ibang:ifoldr,itbang:iunfold}),handle_kmap_forms=operator_case({normal:kmap,bang:keach}),handle_kfilter_forms=operator_case({normal:kfilter,bang:kfilter_not,tbang:kmap_filter}),handle_vmap_forms=operator_case({normal:vmap,bang:veach}),handle_vfilter_forms=operator_case({normal:vfilter,bang:vfilter_not,tbang:vmap_filter}),handle_exists_forms=operator_case({normal:exists,bang:not_exists,tbang:r_exists}),block=anon(qst),block_with_variable=anon(qsu),block_with_init=anon(qsv),block_with_variable_and_init=anon(qsw),block_with_closure=anon(qsx),block_with_seq=anon(qsy),standard_names={_x:"x",_x0:"x0",_xi:"xi",_xl:"xl",_xs:"xs",_xr:"xr"},prefixed_names=function(p){return{_x:p,_x0:(""+(p)+"0"),_xi:(""+(p)+"i"),_xl:(""+(p)+"l"),_xs:(""+(p)+"s"),_xr:(""+(p)+"r")}
},function_promotion=anon(qsz),promote_function=function(f){return function_promotion.replace({_f:f})},closure_wrapper=anon(qs10),close_body=function(vars,f){return closure_wrapper.replace(vars).replace({_f:f})
},seq_pattern=anon(qs11),promote_seq=function(f){return seq_pattern.replace({_x:f})},parse_body=function(tree,expand,normal,init){return(function(){var in_sequence_context=function(f){return expand.call(expand,promote_seq(f))
...
}).call(this)},tbang_modifier=anon(qs12),bang_modifier=anon(qs13),parse_modifiers=function(tree,normal,bang,tbang){return(function(){var result=null;return(((result=tbang_modifier.match(tree))?tbang(result._x):(result=bang_modifier.match(tree))?bang(result._x):normal(tree)))
}).call(this)};return([rule(qs14,qs15),rule(qs16,concat),rule(qs17,qs18),rule(qs19,qs1a),rule(qs1b,qs1c),rule(qs1d,qs1e),rule(qs1f,qs1g),rule(qs1h,qs1i),rule(qs1j,qs1k),rule(qs1l,qs1m),rule(qs1n,qs1o),rule(qs1p,qs1q),rule(qs1r,qs1s),rule(qs1t,qs1u),rule(qs1v,handle_filter_forms),rule(qs1w,handle_map_forms),rule(qs1x,handle_fold_forms),rule(qs1y,handle_exists_forms),rule(qs1z,handle_kmap_forms),rule(qs20,handle_vmap_forms),rule(qs21,handle_kfilter_forms),rule(qs22,handle_vfilter_forms)])
...
},n_pattern=anon(qs23),ni_pattern=anon(qs24),scope=anon(qs25),scoped=function(t){return scope.replace({_body:t})},form=function(p){return(function(){var tree=scoped(anon(p));
return(function(_){return tree.replace(_)})}).call(this)},keys=form(qs26),values=form(qs27),pairs=form(qs28),object=form(qs29),mobject=form(qs2a);return([rule(qs2b,n),rule(qs2c,ni),rule(qs2d,n),rule(qs2e,ni),rule(qs2f,n),rule(qs2g,ni),rule(qs2h,keys),rule(qs2i,object),rule(qs2j,mobject),rule(qs2k,values),rule(qs2l,object),rule(qs2m,mobject),rule(qs2n,pairs),rule(qs2o,object),rule(qs2p,mobject)])
}).call(this);return($.seq=function(caterwaul_function){return(function(){var anon_pattern=anon(qs2q),seq_expand=$($.alternatives(operator_macros.concat(word_macros)));
