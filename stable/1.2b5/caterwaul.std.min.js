...
},j=d("(function (i, u, s) {if ((u - i) * s <= 0) return [];for (var r = [], d = u - i; d > 0 ? i <  u : i >  u; i += s) r.push(i); return r})((_l), (_u), (_step))"),k=d("(function (i, u, s) {if ((u - i) * s <= 0) return [];for (var r = [], d = u - i; d > 0 ? i <= u : i >= u; i += s) r.push(i); return r})((_l), (_u), (_step))"),r=d("(function (o) {_body}).call(this, (S[_o]))"),o=function(n){return r.replace({_body:n})
},g=function(n){return(function(){var s=o(d(n));return((function(t){return s.replace(t)}))}).call(this)},q=g("var ks = []; for (var k in o) Object.prototype.hasOwnProperty.call(o, k) && ks.push(k); return ks"),p=g("var vs = []; for (var k in o) Object.prototype.hasOwnProperty.call(o, k) && vs.push(o[k]); return vs"),f=g("var ps = []; for (var k in o) Object.prototype.hasOwnProperty.call(o, k) && ps.push([k, o[k]]); return ps"),l=g("for (var r = {}, i = 0, l = o.length, x; i < l; ++i) x = o[i], r[x[0]] = x[1]; return r"),m=g("for (var r = {}, i = 0, l = o.length, x; i < l; ++i) x = o[i], (r[x[0]] || (r[x[0]] = [])).push(x[1]); return r");
return([e("S[n[_u]]",i),e("S[ni[_u]]",h),e("S[_o /keys]",q),e("S[_o |object]",l),e("S[_o /mobject",m),e("S[n[_l, _u]]",i),e("S[ni[_l, _u]]",h),e("S[_o /values]",p),e("S[_o -object]",l),e("S[_o -mobject",m),e("S[n[_l, _u, _step]]",i),e("S[ni[_l, _u, _step]]",h),e("S[_o /pairs]",f),e("S[_o /object]",l),e("S[_o |mobject",m)])
