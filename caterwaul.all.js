...
//   Side-effects can be chained since / is left-associative.
    ...
    tconfiguration('std.qs std.qg std.fn', 'std.obj', function () {
      this.configure('std.qg std.fn').rmacro(qs[_/mb/_],  fn[object, method][qs[qg[fn[_o][fn_[_o.m.apply (_o, arguments)]]](o)].replace({_o: this.gensym(), o: object, m: method})]).
                                      ...
                                      rmacro(qs[_/se[_]], fn   [value, body][qs[qg[fn[_][body, _]](value)].replace({body: body, value: value})])}).
...
// its return value is the return value of the unwind_protect block. The escape block can refer to 'e', the escaping value. 'this' is preserved in the body and escape blocks.
  ...
  tconfiguration('std', 'continuation.unwind', function () {
    this.configure('std.fn continuation.core').continuation.unwind_protect = function (escape, f) {try {return f()} catch (e) {return escape(e)}};
    this.continuation.unwind = function (e) {throw e};
...
// | caterwaul.continuation.call_tail(f, arg1, arg2, ...);
  ...
  tconfiguration('std', 'continuation.delimited', function () {
    var magic = this.configure('continuation.core').continuation.magic = {};
...
// End-user library.
  ...
  configuration('continuation', function () {this.configure('continuation.core continuation.cps continuation.delimited')});
