...
//   to be used.
    ...
    syntax_node = extend(function (data) {if (data instanceof this.constructor) this.data = data.data, this.length = 0;
                                                ...
                                                for (var i = 1, l = arguments.length, _; _ = arguments[i], i < l; ++i)
                                                  for (var j = 0, lj = _.length, it; _ instanceof Array ? (it = _[j], j < lj) : (it = _, ! j); ++j)
                                                    this._append(it instanceof String || it instanceof Number || it instanceof Boolean ? new this.constructor(it) : it)}}, node_methods),
