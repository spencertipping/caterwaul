...
if(block.data===parse_accepts[this.data]){block=block[1]}return this.data==="{"||has(parse_r_until_block,this.data)&&(this.data!=="function"||this.length===3)&&block&&block.ends_with_block()
