...
}),function(){this.data=r}):r:this.map(function(n){return n.replace(rs)})},thin_clone:function(){var c=new this.constructor(this.data,Array.prototype.slice.call(this));
c.prefix_data=this.prefix_data,c.infix_data=this.infix_data,c.suffix_data=this.suffix_data;return c},repopulated_with:function(xs){return new this.constructor(this.data,xs)
