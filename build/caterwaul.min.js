...
prefix=[];return k};if(l===0){return empty}while((mark=i)<l){esc=exp=dot=t=0;if(lex_space[c]){while(++i<l&&lex_space[c=cs(i)]){}}else{if(lex_bracket[c]){++i,t=1,re=lex_opener[c]
