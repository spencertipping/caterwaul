...
}else{return this[0].serialize(xs,d1),push(d),this[1].serialize(xs,d1)}}}}default:if(has(parse_ternary,d)){return this[0].serialize(xs,d1),push(d),this[1].serialize(xs,d1),push(":"),this[2].serialize(xs,d1)
