...
},prefixes:function(){return this.prefix_data||(this.prefix_data=[])},suffix:function(d){return this.suffixes().push(d),this},suffixes:function(){return this.suffix_data||(this.suffix_data=[])
...
});return this_p>p?result.as("("):result},serialize:function(xs,depth){var l=this.length,d=this.data,d1=depth-1,e=function(x){xs.push(x)},p=this.prefix_data?this.prefix_data.join(""):" ",s=this.suffix_data?this.suffix_data.join(""):" ";
if(l&&depth===0){return e("...")}switch(l){case 0:if(has(parse_r_optional,d)){return e(p),e(d.replace(/^u/,""))}else{if(has(parse_group,d)){return e(p),e(d),e(parse_group[d])
}else{return e(p),e(d)}}case 1:if(has(parse_r,d)||has(parse_r_optional,d)){return e(p),e(d.replace(/^u/,"")),this[0].serialize(xs,d1),e(s)}else{if(has(parse_misleading_postfix,d)){return this[0].serialize(xs,d1),e(p),e(d),e(s)
}else{if(has(parse_group,d)){return e(p),e(d),this[0].serialize(xs,d1),e(s),e(parse_group[d])}else{if(has(parse_lr,d)){return e(p),this[0].serialize(xs,d1),e(s)}else{return this[0].serialize(xs,d1),e(p),e(d),e(s)
}}}}case 2:if(has(parse_invocation,d)){return this[0].serialize(xs,d1),e(p),e(d.charAt(0)),this[1].serialize(xs,d1),e(s),e(d.charAt(1))}else{if(has(parse_r_until_block,d)){return e(p),e(d),this[0].serialize(xs,d1),this[1].serialize(xs,d1),e(s)
}else{if(has(parse_invisible,d)){return this[0].serialize(xs,d1),this[1].serialize(xs,d1),e(s)}else{if(d===";"){return this[0].serialize(xs,d1),e(p),e(";"),this[1].serialize(xs,d1),e(s)
}else{return this[0].serialize(xs,d1),e(p),e(d),this[1].serialize(xs,d1),e(s)}}}}default:if(has(parse_ternary,d)){return this[0].serialize(xs,d1),e(p),e(d),this[1].precedence()>this.precedence()?(this[1].as("(").serialize(xs,d1),e(s),e(":"),this[2].serialize(xs,d1)):(this[1].serialize(xs,d1),e(s),e(":"),this[2].serialize(xs,d1))
...
}if(t===false){prefix.push(s.substring(mark,i))}t=t===true?s.substring(mark,i):t==="u;"?";":t;t===gs_top?(grouping_stack.pop(),gs_top=grouping_stack[grouping_stack.length-1],head.suffix_data=prefix,prefix=[],head=head?head.p:parent,parent=null):(has(parse_group,t)?(grouping_stack.push(gs_top=parse_group[t]),parent=push(new_node(new syntax_node(t))),groups.push(parent),head=null):push(new_node(new syntax_node(t))),has(parse_inverse_order,t)&&indexes[parse_inverse_order[t]].push(head||parent));
