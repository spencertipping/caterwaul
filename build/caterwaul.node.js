...
//   macroexpand() function takes optional extra parameters; these are either macros or arrays of macros to be added to the macro list stored on the caterwaul function.
    ...
    caterwaul_global.macroexpand = function (tree) {for (var macros = arguments.length ? [].concat(this.macros || []) : this.macros || [], i = 1, l = arguments.length, x; i < l; ++i)
                                                    ...
                                                    var context = {caterwaul: this, macros: macros, expand: function (tree) {
                                                      for (var new_tree = null, i = macros.length - 1; i >= 0; --i) if (new_tree = macros[i].call(context, tree)) return new_tree;
                                                      return tree}};
...
//   I'm (ab)using the constructor property here. I'd like to convey the idea that functions produced by caterwaul() are instances of caterwaul, even though Javascript won't see it that way.
    ...
    caterwaul_global.setup_state = function (compiler, driver_function) {
      return merge(compiler, caterwaul_global.instance_methods, {driver_function: driver_function}, {macros: [], environment: {}})};
// Generated by SDoc 
...
caterwaul.version('0696726f67d4f7abacb5d0c9023dfdb6');
// Generated by SDoc 
