...
caterwaul.js_base()(function ($) {
  ...
  -where [anon            = $.anonymizer('S'),
          ...
          word_macros     = [rule('S[n[_upper]]',                n),  rule('S[_o /keys]',    keys),    rule('S[_xs |object]', object),
                             rule('S[n[_lower, _upper]]',        n),  rule('S[_o /values]',  values),  rule('S[_xs -object]', object),
                             rule('S[n[_lower, _upper, _step]]', n),  rule('S[_o /pairs]',   pairs),   rule('S[_xs /object]', object)]
