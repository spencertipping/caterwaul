...
},promote=function(f,body){return(f).replace({_f:f.uses_x0?(qsz).replace({_f:body}):(qs10).replace({_f:body}),_s:xs})};return(((r=qs11.match(body)||qs12.match(body))?use(iform,r):(r=qs13.match(body)||qs14.match(body))?use(form,r):promote(form,body)))
