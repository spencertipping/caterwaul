...
}return xr}).call(this,Array.prototype.slice.call((xs))))));return(function(_){return function(){return unescape_string(this.as_escaped_string())}})}).call(this)
...
caterwaul.module("std.js-literals",(function(qse1,qse2){var result=(function($){$.js_literals=function(c){return(function(it){return($.merge(it.literal_modifiers.regexp,{x:$.reexpander((function(n){return(n).with_data(n.data.replace(/\s+/g,""))
})),qf:function(node){return(qse1).replace({_regexp:node})}}),$.merge(it.literal_modifiers.string,{qw:$.reexpander(function(node){for(var array_node=new $.syntax("["),comma=new $.syntax(","),delimiter=node.data.charAt(0),pieces=node.as_escaped_string().split(/\s+/),i=0,l=pieces.length;
i<l;++i){comma.push(new $.syntax(delimiter+pieces[i]+delimiter))}return array_node.push(comma.unflatten())}),qh:$.reexpander(function(node){for(var hash_node=new $.syntax("{"),comma=new $.syntax(","),delimiter=node.data.charAt(0),pieces=node.as_escaped_string().split(/\s+/),i=0,l=pieces.length;
...
}),qr:$.reexpander((function(node){return node.with_data("/"+node.as_escaped_string().replace(/\//g,"\\/")+"/")})),qs:function(node){return new $.expression_ref($.syntax_to_expression($.parse(node.as_unescaped_string())),"qs")
},qse:function(node){return new $.expression_ref($.syntax_to_expression(this.call(this,$.parse(node.as_unescaped_string()))),"qse")},qf:$.reexpander((function(node){return(qse2).replace({_body:$.parse(node.as_unescaped_string)})
}))})),it}).call(this,(c))}});result.caterwaul_expression_ref_table={qse1:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_regexp" ) ,new caterwaul.syntax( "exec" ) ) ,new caterwaul.syntax( "_" ) ) ) ) ) )'),qse2:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_body" ) ) ) ) )')};
return(result)}).call(this,new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_regexp"),new caterwaul.syntax("exec")),new caterwaul.syntax("_")))))),new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_")),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_body")))))));
...
},expand=(function(it){return settings.descend?$(it):it}).call(this,($.alternatives(rule_cc(rule,anon))));return(function(_){return function(){return unescape_string(this.as_escaped_string())
}})}).call(this)}});result.caterwaul_expression_ref_table={qs:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_expression" ) )')};
...
},scope=anon(qs23),scoped=function(t){return scope.replace({_body:t})},form=function(p){return(function(){var tree=scoped(anon(p));return(function(_){return function(){return unescape_string(this.as_escaped_string())
