...
return(create_form(xs,resulting.body,resulting.form,resulting.iform))}).call(this)},parse_prefix=function(body,form,iform){return(function(){var r=null,transform=(r=qsw.match(body))?function(_){return promote_seq(close_body(_))
...
},create_form=function(xs,body,form,iform){return(function(){var r=null,use=function(f,match){return f.replace($.merge({_f:match._x,_init:match._init,_s:xs},names_for(match._var)))
