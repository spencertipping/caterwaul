...
return((function(){var unrecognized=function(reason){return(function(){throw new Error(reason)}).call(this)},operator_case=function(forms){return function(match){return(function(){var expander=this,use=function(form,iform){return function(body){return render_form.call(expander,match._xs,body,form,iform)
}};return(parse_modifiers(match._thing,use(forms.normal,forms.inormal),use(forms.bang,forms.ibang),use(forms.tbang,forms.itbang)))}).call(this)}},handle_map_forms=operator_case({normal:map,bang:each,tbang:flatmap,itbang:iterate}),handle_filter_forms=operator_case({normal:filter,bang:filter_not,tbang:map_filter,itbang:imap_filter}),handle_fold_forms=operator_case({normal:foldl,bang:foldr,tbang:unfold,inormal:ifoldl,ibang:ifoldr,itbang:iunfold}),handle_kmap_forms=operator_case({normal:kmap,bang:keach}),handle_kfilter_forms=operator_case({normal:kfilter,bang:kfilter_not,tbang:kmap_filter}),handle_vmap_forms=operator_case({normal:vmap,bang:veach}),handle_vfilter_forms=operator_case({normal:vfilter,bang:vfilter_not,tbang:vmap_filter}),handle_exists_forms=operator_case({normal:exists,bang:not_exists,tbang:r_exists}),parse_modifiers=function(tree,n,b,tb){return(function(){var r=null;
return(((r=qsu.match(tree))?tb(r._x):(r=qsv.match(tree))?b(r._x):n(tree)))}).call(this)},render_form=function(xs,body,form,iform){return(function(){var resulting=parse_prefix(body,form,iform);
return(create_form.call(this,xs,resulting.body,resulting.form,resulting.iform))}).call(this)},parse_prefix=function(body,form,iform){return(function(){var r=null,transform=(r=qsw.match(body))?function(_){return promote_seq(close_body(_))
}:(r=qsx.match(body))?promote_seq:(r=qsy.match(body))?close_body:function(_){return _};return({form:transform(form),iform:transform(iform),body:r?r._x:body})}).call(this)
},create_form=function(xs,body,form,iform){return(function(){var r=null,expander=this,use=function(f,match){return expander.call(expander,f.replace($.merge({_f:match._x,_init:match._init,_s:xs},names_for(match._var))))
},promote=function(f,body){return((f).replace({_f:(f.uses_x0?qsz:qs10).replace($.merge({_f:body},gensym_names)),_s:xs})).replace(gensym_names)};return(((r=qs11.match(body)||qs12.match(body))?use(iform,r):(r=qs13.match(body)||qs14.match(body))?use(form,r):promote(form,body)))
...
}}return xr}).call(this,names_for(null)),close_body=function(f){return(qs15).replace({_f:f})},promote_seq_template=anon(qs16),promote_seq=function(f){return(promote_seq_template).replace({_x:f})
