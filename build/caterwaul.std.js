...
// Caterwaul module system | Spencer Tipping
// Licensed under the terms of the MIT source code license

// Introduction.
// Until the Waul precompiler was written, there wasn't much point in creating extra structure for Caterwaul modules. It was sufficient for scripts to just assign attributes to the Caterwaul
// global. However, a more structured approach has some advantages. For example, it would be nice to have replayable module initialization functions so that you could send modules as code from
// the server to the client. This library manages that abstraction.
// Generated by SDoc 
...
caterwaul.module('std.js', function ($) {
...
caterwaul.module('std.js-literals', function ($) {
...
caterwaul.module('std.seq', 'js words', function ($) {
  ...
  where [anon            = $.anonymizer('S'),
         ...
         word_macros     = [rule('S[n[_upper]]',                n),  rule('S[ni[_upper]]',                ni),  rule('S[_o /keys]',   keys),    rule('S[_o |object]', object),
                    ...
                    -where [n(match)   = n_pattern .replace($.merge({_lower: '0', _step: '1'}, match)),
                            ...
                            object     = form('for (var r = {}, i = 0, l = o.length, x; i < l; ++i) x = o[i], r[x[0]] = x[1]; return r')]]});
...
// Generated by SDoc 
  ...
  caterwaul.module('std', function ($) {$.js_all = function () {return this.seq(this.words(this.js_literals(this.js())))}});
