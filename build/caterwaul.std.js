...
// Composition extension | Spencer Tipping
// Licensed under the terms of the MIT source code license

// Introduction.
// Composition lets you create derivative Caterwaul instances that incorporate certain transformations before or after others. Specifically, you can change the behavior of the macroexpansion
// layer by introducing an extra step before compilation or after parsing:

// | c1 = caterwaul('js_all')
//   c2 = caterwaul('something_else')
//   c1.after(c2)(f)               -> c2.compile(c1(c2(c2.parse(f))))
//   c1.before(c2)(f)              -> c2.compile(c2(c1(c2.parse(f))))

(function ($) {caterwaul.before = function (c) {var t = this; return $(function (tree) {return t.call(this, c.call(this, tree))})},
               caterwaul.after  = function (c) {return c.before(this)}})(caterwaul);
