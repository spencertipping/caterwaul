...
caterwaul.tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmtjkzfr_anhw74=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('precompiled_internal')),new caterwaul.syntax('_x'));
var gensym_1_gmtjkzfr_anhw75=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax('_name')));
var gensym_1_gmtjkzfr_anhw76=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax(',',new caterwaul.syntax('_name'),new caterwaul.syntax('_children'))));
var gensym_1_gmtjkzfr_anhw77=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('clone')),new caterwaul.syntax('_string'));
...
return (((matches)&&(matches._gensym.data)))}).call(this)}),mark_as_compiled=(function (references,k,tree,environment){return ((k&&references[k])&&((function (it){return (references[k].compiled=tree,references[k].environment=environment),it}).call(this,((function (it){return (((references[k].compiled)&&((function (){throw new Error(('detected multiple compilations of '+(references[k].tree.serialize())+''))}).call(this)))),it}).call(this,(references[k]))))))}),wrapped_compile=(function (original,references){return (function (tree,environment){return (function (it){return (mark_as_compiled(references,function_key(tree),tree,caterwaul.merge({},this.globals,environment))),it}).call(this,(original.call(this,tree,environment)))})}),signal_already_compiled=(function (tree){return gensym_1_gmtjkzfr_anhw74.replace({_x:tree})}),closure_template=caterwaul.parse('(function () {_vars; return (_value)}).call(this)'),closure_variable_template=caterwaul.parse('var _var = _value'),closure_null_template=caterwaul.parse('null'),escape_string=(function (s){return '\''+s.replace(/\\/g,'\\\\').replace(/\n/g,'\\n').replace(/'/g,'\\\'')+'\''}),caterwaul_ref_string=(function (configurations){return '\''+(function (){var gensym_1_gmtjkzfr_anhw6y=(configurations),gensym_1_gmtjkzfr_anhw6z=[];
for (var it in gensym_1_gmtjkzfr_anhw6y)Object.prototype.hasOwnProperty.call(gensym_1_gmtjkzfr_anhw6y,it)&&gensym_1_gmtjkzfr_anhw6z.push(it);
return gensym_1_gmtjkzfr_anhw6z}).call(this)+'\''}),serialize_syntax=(function (value){return value.length===0?gensym_1_gmtjkzfr_anhw75.replace({_name:escape_string(value.data)}):(function (){var children=new caterwaul.syntax(',',(function (){for (var gensym_1_gmtjkzfr_anhw6u=(value),gensym_1_gmtjkzfr_anhw6v=[],gensym_1_gmtjkzfr_anhw6w=0,gensym_1_gmtjkzfr_anhw6x=gensym_1_gmtjkzfr_anhw6u.length,it;
gensym_1_gmtjkzfr_anhw6w<gensym_1_gmtjkzfr_anhw6x;
 ++gensym_1_gmtjkzfr_anhw6w)it=gensym_1_gmtjkzfr_anhw6u[gensym_1_gmtjkzfr_anhw6w],gensym_1_gmtjkzfr_anhw6v.push(serialize_syntax(it));
return gensym_1_gmtjkzfr_anhw6v}).call(this)).unflatten();
return (gensym_1_gmtjkzfr_anhw76.replace({_name:escape_string(value.data),_children:children}))}).call(this)}),serialize_caterwaul=(function (value){return gensym_1_gmtjkzfr_anhw77.replace({_string:caterwaul_ref_string(value.has)})}),serialize_ref=(function (value,name,seen){return  !value?(''+(value)+''):value.constructor===caterwaul.syntax?seen[value.id()]||(function (it){return (serialize_syntax(value))}).call(this,((seen[value.id()]=name))):value.is_caterwaul===caterwaul.is_caterwaul?seen[value.id()]||(function (it){return (serialize_caterwaul(value))}).call(this,((seen[value.id()]=name))):(function (){throw new Error(('syntax ref value is not serializable: '+(value)+''))}).call(this)}),single_variable=(function (name,value){return closure_variable_template.replace({_var:name,_value:value})}),names_and_values_for=(function (environment){return (function (){var gensym_1_gmtjkzfr_anhw6y=(environment),gensym_1_gmtjkzfr_anhw6z=[];
for (var it in gensym_1_gmtjkzfr_anhw6y)Object.prototype.hasOwnProperty.call(gensym_1_gmtjkzfr_anhw6y,it)&&gensym_1_gmtjkzfr_anhw6z.push(single_variable(it,environment[it]));
return gensym_1_gmtjkzfr_anhw6z}).call(this)}),tree_variables=(function (tree){return (function (){var vars=[],seen={};
...
caterwaul.shallow('trace',caterwaul.clone().tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmtjkzfr_anhw7u=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmtjkzfr_anhw7v=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmtjkzfr_anhw7w=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmtjkzfr_anhw7x=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y'))),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmtjkzfr_anhw7y=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmtjkzfr_anhw7z=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('_y')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmtjkzfr_anhw80=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('+',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmtjkzfr_anhw81=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('+',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmtjkzfr_anhw82=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('u+',new caterwaul.syntax('_x')));
var gensym_1_gmtjkzfr_anhw83=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('u+',new caterwaul.syntax('[]',new caterwaul.syntax('T'),new caterwaul.syntax('_x')))));
var gensym_1_gmtjkzfr_anhw84=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_expression'))));
var gensym_1_gmtjkzfr_anhw85=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_object')),new caterwaul.syntax('_method')),new caterwaul.syntax('[',new caterwaul.syntax('_parameters')))));
return (function (){(function (){var qw=(function (s){return s.split(/\s+/)});
return (this.event('before_trace','after_trace'),(function (){for (var gensym_1_gmtjkzfr_anhw7k=(qw('E S H D I')),gensym_1_gmtjkzfr_anhw7l=[],gensym_1_gmtjkzfr_anhw7m=0,gensym_1_gmtjkzfr_anhw7n=gensym_1_gmtjkzfr_anhw7k.length,it;
gensym_1_gmtjkzfr_anhw7m<gensym_1_gmtjkzfr_anhw7n;
 ++gensym_1_gmtjkzfr_anhw7m)it=gensym_1_gmtjkzfr_anhw7k[gensym_1_gmtjkzfr_anhw7m],gensym_1_gmtjkzfr_anhw7l.push(this.state_marker(it));
return gensym_1_gmtjkzfr_anhw7l}).call(this),this.method('assignment_operator',(function (op){return this.tmacro(gensym_1_gmtjkzfr_anhw7u.replace({'=':op}),gensym_1_gmtjkzfr_anhw7v.replace({'=':op})).tmacro(gensym_1_gmtjkzfr_anhw7w.replace({'=':op}),gensym_1_gmtjkzfr_anhw7x.replace({'=':op})).tmacro(gensym_1_gmtjkzfr_anhw7y.replace({'=':op}),gensym_1_gmtjkzfr_anhw7z.replace({'=':op}))})).method('binary_operator',(function (op){return this.tmacro(gensym_1_gmtjkzfr_anhw80.replace({'+':op}),gensym_1_gmtjkzfr_anhw81.replace({'+':op}))})).method('unary_operator',(function (op){return this.tmacro(gensym_1_gmtjkzfr_anhw82.replace({'u+':('u'+(op)+'')}),gensym_1_gmtjkzfr_anhw83.replace({'u+':('u'+(op)+'')}))})),this.tmacro('E[]','null').tmacro('E[_x]','H[_, _x]'),(function (){for (var gensym_1_gmtjkzfr_anhw7k=(qw('= += -= *= /= %= &= |= ^= <<= >>= >>>=')),gensym_1_gmtjkzfr_anhw7l=[],gensym_1_gmtjkzfr_anhw7m=0,gensym_1_gmtjkzfr_anhw7n=gensym_1_gmtjkzfr_anhw7k.length,it;
gensym_1_gmtjkzfr_anhw7m<gensym_1_gmtjkzfr_anhw7n;
 ++gensym_1_gmtjkzfr_anhw7m)it=gensym_1_gmtjkzfr_anhw7k[gensym_1_gmtjkzfr_anhw7m],gensym_1_gmtjkzfr_anhw7l.push(this.assignment_operator(it));
return gensym_1_gmtjkzfr_anhw7l}).call(this),(function (){for (var gensym_1_gmtjkzfr_anhw7k=(qw('() [] + - * / % < > <= >= == != === !== in instanceof ^ & | && ||')),gensym_1_gmtjkzfr_anhw7l=[],gensym_1_gmtjkzfr_anhw7m=0,gensym_1_gmtjkzfr_anhw7n=gensym_1_gmtjkzfr_anhw7k.length,it;
gensym_1_gmtjkzfr_anhw7m<gensym_1_gmtjkzfr_anhw7n;
 ++gensym_1_gmtjkzfr_anhw7m)it=gensym_1_gmtjkzfr_anhw7k[gensym_1_gmtjkzfr_anhw7m],gensym_1_gmtjkzfr_anhw7l.push(this.binary_operator(it));
return gensym_1_gmtjkzfr_anhw7l}).call(this),(function (){for (var gensym_1_gmtjkzfr_anhw7k=(qw('+ - ! ~')),gensym_1_gmtjkzfr_anhw7l=[],gensym_1_gmtjkzfr_anhw7m=0,gensym_1_gmtjkzfr_anhw7n=gensym_1_gmtjkzfr_anhw7k.length,it;
gensym_1_gmtjkzfr_anhw7m<gensym_1_gmtjkzfr_anhw7n;
 ++gensym_1_gmtjkzfr_anhw7m)it=gensym_1_gmtjkzfr_anhw7k[gensym_1_gmtjkzfr_anhw7m],gensym_1_gmtjkzfr_anhw7l.push(this.unary_operator(it));
