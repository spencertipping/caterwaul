...
caterwaul.tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmy2hxkf_9a4yfh=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('precompiled_internal')),new caterwaul.syntax('_x'));
var gensym_1_gmy2hxkf_9a4yfi=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax('_name')));
var gensym_1_gmy2hxkf_9a4yfj=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax(',',new caterwaul.syntax('_name'),new caterwaul.syntax('_children'))));
var gensym_1_gmy2hxkf_9a4yfk=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('clone')),new caterwaul.syntax('_string'));
...
return (((matches)&&(matches._gensym.data)))}).call(this)}),mark_as_compiled=(function (references,k,tree,environment){return ((k&&references[k])&&((function (it){return (references[k].compiled=tree,references[k].environment=environment),it}).call(this,((function (it){return (((references[k].compiled)&&((function (){throw new Error(('detected multiple compilations of '+(references[k].tree.serialize())+''))}).call(this)))),it}).call(this,(references[k]))))))}),wrapped_compile=(function (original,references){return (function (tree,environment){return (function (it){return (mark_as_compiled(references,function_key(tree),tree,caterwaul.merge({},this.globals,environment))),it}).call(this,(original.call(this,tree,environment)))})}),signal_already_compiled=(function (tree){return gensym_1_gmy2hxkf_9a4yfh.replace({_x:tree})}),closure_template=caterwaul.parse('(function () {_vars; return (_value)}).call(this)'),closure_variable_template=caterwaul.parse('var _var = _value'),closure_null_template=caterwaul.parse('null'),escape_string=(function (s){return '\''+s.replace(/\\/g,'\\\\').replace(/\n/g,'\\n').replace(/'/g,'\\\'')+'\''}),caterwaul_ref_string=(function (configurations){return '\''+(function (){var gensym_1_gmy2hxkf_9a4yfb=(configurations),gensym_1_gmy2hxkf_9a4yfc=[];
for (var it in gensym_1_gmy2hxkf_9a4yfb)Object.prototype.hasOwnProperty.call(gensym_1_gmy2hxkf_9a4yfb,it)&&gensym_1_gmy2hxkf_9a4yfc.push(it);
return gensym_1_gmy2hxkf_9a4yfc}).call(this)+'\''}),serialize_syntax=(function (value){return value.length===0?gensym_1_gmy2hxkf_9a4yfi.replace({_name:escape_string(value.data)}):(function (){var children=new caterwaul.syntax(',',(function (){for (var gensym_1_gmy2hxkf_9a4yf7=(value),gensym_1_gmy2hxkf_9a4yf8=[],gensym_1_gmy2hxkf_9a4yf9=0,gensym_1_gmy2hxkf_9a4yfa=gensym_1_gmy2hxkf_9a4yf7.length,it;
gensym_1_gmy2hxkf_9a4yf9<gensym_1_gmy2hxkf_9a4yfa;
 ++gensym_1_gmy2hxkf_9a4yf9)it=gensym_1_gmy2hxkf_9a4yf7[gensym_1_gmy2hxkf_9a4yf9],gensym_1_gmy2hxkf_9a4yf8.push(serialize_syntax(it));
return gensym_1_gmy2hxkf_9a4yf8}).call(this)).unflatten();
return (gensym_1_gmy2hxkf_9a4yfj.replace({_name:escape_string(value.data),_children:children}))}).call(this)}),serialize_caterwaul=(function (value){return gensym_1_gmy2hxkf_9a4yfk.replace({_string:caterwaul_ref_string(value.has)})}),serialize_ref=(function (value,name,seen){return  !value?(''+(value)+''):value.constructor===caterwaul.syntax?seen[value.id()]||(function (it){return (serialize_syntax(value))}).call(this,((seen[value.id()]=name))):value.is_caterwaul===caterwaul.is_caterwaul?seen[value.id()]||(function (it){return (serialize_caterwaul(value))}).call(this,((seen[value.id()]=name))):(function (){throw new Error(('syntax ref value is not serializable: '+(value)+''))}).call(this)}),single_variable=(function (name,value){return closure_variable_template.replace({_var:name,_value:value})}),names_and_values_for=(function (environment){return (function (){var gensym_1_gmy2hxkf_9a4yfb=(environment),gensym_1_gmy2hxkf_9a4yfc=[];
for (var it in gensym_1_gmy2hxkf_9a4yfb)Object.prototype.hasOwnProperty.call(gensym_1_gmy2hxkf_9a4yfb,it)&&gensym_1_gmy2hxkf_9a4yfc.push(single_variable(it,environment[it]));
return gensym_1_gmy2hxkf_9a4yfc}).call(this)}),tree_variables=(function (tree){return (function (){var vars=[],seen={};
...
caterwaul.shallow('trace',caterwaul.clone().tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmy2hxkf_9a4yg7=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmy2hxkf_9a4yg8=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmy2hxkf_9a4yg9=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmy2hxkf_9a4yga=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y'))),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmy2hxkf_9a4ygb=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmy2hxkf_9a4ygc=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('_y')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmy2hxkf_9a4ygd=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('+',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmy2hxkf_9a4yge=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('+',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmy2hxkf_9a4ygf=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('u+',new caterwaul.syntax('_x')));
var gensym_1_gmy2hxkf_9a4ygg=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('u+',new caterwaul.syntax('[]',new caterwaul.syntax('T'),new caterwaul.syntax('_x')))));
var gensym_1_gmy2hxkf_9a4ygh=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_expression'))));
var gensym_1_gmy2hxkf_9a4ygi=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_object')),new caterwaul.syntax('_method')),new caterwaul.syntax('[',new caterwaul.syntax('_parameters')))));
return (function (){(function (){var qw=(function (s){return s.split(/\s+/)});
return (this.event('before_trace','after_trace'),(function (){for (var gensym_1_gmy2hxkf_9a4yfx=(qw('E S H D I')),gensym_1_gmy2hxkf_9a4yfy=[],gensym_1_gmy2hxkf_9a4yfz=0,gensym_1_gmy2hxkf_9a4yg0=gensym_1_gmy2hxkf_9a4yfx.length,it;
gensym_1_gmy2hxkf_9a4yfz<gensym_1_gmy2hxkf_9a4yg0;
 ++gensym_1_gmy2hxkf_9a4yfz)it=gensym_1_gmy2hxkf_9a4yfx[gensym_1_gmy2hxkf_9a4yfz],gensym_1_gmy2hxkf_9a4yfy.push(this.state_marker(it));
return gensym_1_gmy2hxkf_9a4yfy}).call(this),this.method('assignment_operator',(function (op){return this.tmacro(gensym_1_gmy2hxkf_9a4yg7.replace({'=':op}),gensym_1_gmy2hxkf_9a4yg8.replace({'=':op})).tmacro(gensym_1_gmy2hxkf_9a4yg9.replace({'=':op}),gensym_1_gmy2hxkf_9a4yga.replace({'=':op})).tmacro(gensym_1_gmy2hxkf_9a4ygb.replace({'=':op}),gensym_1_gmy2hxkf_9a4ygc.replace({'=':op}))})).method('binary_operator',(function (op){return this.tmacro(gensym_1_gmy2hxkf_9a4ygd.replace({'+':op}),gensym_1_gmy2hxkf_9a4yge.replace({'+':op}))})).method('unary_operator',(function (op){return this.tmacro(gensym_1_gmy2hxkf_9a4ygf.replace({'u+':('u'+(op)+'')}),gensym_1_gmy2hxkf_9a4ygg.replace({'u+':('u'+(op)+'')}))})),this.tmacro('E[]','null').tmacro('E[_x]','H[_, _x]'),(function (){for (var gensym_1_gmy2hxkf_9a4yfx=(qw('= += -= *= /= %= &= |= ^= <<= >>= >>>=')),gensym_1_gmy2hxkf_9a4yfy=[],gensym_1_gmy2hxkf_9a4yfz=0,gensym_1_gmy2hxkf_9a4yg0=gensym_1_gmy2hxkf_9a4yfx.length,it;
gensym_1_gmy2hxkf_9a4yfz<gensym_1_gmy2hxkf_9a4yg0;
 ++gensym_1_gmy2hxkf_9a4yfz)it=gensym_1_gmy2hxkf_9a4yfx[gensym_1_gmy2hxkf_9a4yfz],gensym_1_gmy2hxkf_9a4yfy.push(this.assignment_operator(it));
return gensym_1_gmy2hxkf_9a4yfy}).call(this),(function (){for (var gensym_1_gmy2hxkf_9a4yfx=(qw('() [] + - * / % < > <= >= == != === !== in instanceof ^ & | && ||')),gensym_1_gmy2hxkf_9a4yfy=[],gensym_1_gmy2hxkf_9a4yfz=0,gensym_1_gmy2hxkf_9a4yg0=gensym_1_gmy2hxkf_9a4yfx.length,it;
gensym_1_gmy2hxkf_9a4yfz<gensym_1_gmy2hxkf_9a4yg0;
 ++gensym_1_gmy2hxkf_9a4yfz)it=gensym_1_gmy2hxkf_9a4yfx[gensym_1_gmy2hxkf_9a4yfz],gensym_1_gmy2hxkf_9a4yfy.push(this.binary_operator(it));
return gensym_1_gmy2hxkf_9a4yfy}).call(this),(function (){for (var gensym_1_gmy2hxkf_9a4yfx=(qw('+ - ! ~')),gensym_1_gmy2hxkf_9a4yfy=[],gensym_1_gmy2hxkf_9a4yfz=0,gensym_1_gmy2hxkf_9a4yg0=gensym_1_gmy2hxkf_9a4yfx.length,it;
gensym_1_gmy2hxkf_9a4yfz<gensym_1_gmy2hxkf_9a4yg0;
 ++gensym_1_gmy2hxkf_9a4yfz)it=gensym_1_gmy2hxkf_9a4yfx[gensym_1_gmy2hxkf_9a4yfz],gensym_1_gmy2hxkf_9a4yfy.push(this.unary_operator(it));
