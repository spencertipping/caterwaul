caterwaul.module( 'std.js-literals' , (function(qs_h_eVx2_iObQjUCcopYa$hDYS,qs_i_eVx2_iObQjUCcopYa$hDYS) {var result_j_eVx2_iObQjUCcopYa$hDYS= (function($) {$.js_literals=function(caterwaul_function) {var function_template=qs_h_eVx2_iObQjUCcopYa$hDYS;
 (function(r) {r.x=$.reexpander(function(node) {return node.with_data(node.data.replace( /\s+/g , '' ) ) } ) ;
var call_exec_template=qs_i_eVx2_iObQjUCcopYa$hDYS;
...
result_j_eVx2_iObQjUCcopYa$hDYS.caterwaul_expression_ref_table= { "qs_h_eVx2_iObQjUCcopYa$hDYS" : ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"_\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"_body\" ) ) ) )" ) , "qs_i_eVx2_iObQjUCcopYa$hDYS" : ( "new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_regexp\" ) ,new caterwaul.syntax( \"exec\" ) ) ,new caterwaul.syntax( \"_\" ) )" ) } ;
return(result_j_eVx2_iObQjUCcopYa$hDYS) } ) .call(this,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_body" ) ) ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_regexp" ) ,new caterwaul.syntax( "exec" ) ) ,new caterwaul.syntax( "_" ) ) ) ) ;
