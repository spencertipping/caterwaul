caterwaul.module( 'std.js-literals' , (function(qs_h_CISLpn329zisArgAIruBPu,qs_i_CISLpn329zisArgAIruBPu) {var result_j_CISLpn329zisArgAIruBPu= (function($) {$.js_literals=function(caterwaul_function) {var function_template=qs_h_CISLpn329zisArgAIruBPu;
 (function(r) {r.x=$.reexpander(function(node) {return node.with_data(node.data.replace( /\s+/g , '' ) ) } ) ;
var call_exec_template=qs_i_CISLpn329zisArgAIruBPu;
...
result_j_CISLpn329zisArgAIruBPu.caterwaul_expression_ref_table= { "qs_h_CISLpn329zisArgAIruBPu" : ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"_\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"_body\" ) ) ) )" ) , "qs_i_CISLpn329zisArgAIruBPu" : ( "new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_regexp\" ) ,new caterwaul.syntax( \"exec\" ) ) ,new caterwaul.syntax( \"_\" ) )" ) } ;
return(result_j_CISLpn329zisArgAIruBPu) } ) .call(this,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_body" ) ) ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_regexp" ) ,new caterwaul.syntax( "exec" ) ) ,new caterwaul.syntax( "_" ) ) ) ) ;
