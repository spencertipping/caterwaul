...
//   This loads all of the production-use extensions.
    ...
    configuration('std', function () {this.configure('std.qs std.qg std.bind std.lvalue std.cond std.fn std.defmacro std.with_gensyms std.ref std.compile_eval std.string')})});
