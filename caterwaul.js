...
//     Doing this can be useful for debugging macros, configurations, or other things.
    ...
    configuration('recon', function () {var old_init = this.init, recon = merge(function (tree) {return recon.annotate(tree)},
...
//         A(op x)           ->    f(op A(x))
//         A(x.y(z))         ->    (function () {var _gensym_ = A(x); return A(_gensym_.y).call(_gensym_, z)})()
//         A(x[y](z))        ->    (function () {var _gensym_ = A(x); return A(_gensym_[y]).call(_gensym_, z)})()
//         A(x(y))           ->    A(rvalue)(A(rvalue))
//         A(if (v1) v2)     ->    if (A(v1)) A(v2)
//         A({n ...})        ->    {A(n.flatten())}
//         A(x [op]= y)      ->    x = A(y)
...
//         A(x[y] [op]= z)   ->    A(x)[y] = A(z)
      ...
      {});
                                        ...
                                        this.method('init', function (f) {return recon(old_init.call(this, f))}).ref('recon', this.util.configurable(recon, 'aggressive'))})});
