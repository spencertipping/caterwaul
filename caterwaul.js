...
//   else, while, and catch are associated with their containing if, do, and try blocks respectively. This can be done easily, as the syntax is folded right-to-left.

    parse_link = extend (fn('this.left = this.right = null, this.data = $0, this.children = $1 || []'), {
      append: fn('$0.right = this.right, ($0.left = this).right = $0, this'), prepend: fn('$0.left = this.left, ($0.right = this).left = $0, this'),
      remove: fn('($0 = this.left) && (this.left.right = this.right), this.right && (this.right.left = $0), this')}),
