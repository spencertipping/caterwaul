...
// Generated by SDoc 
  ...
  caterwaul.js.words       = caterwaul.words(caterwaul.js);
  caterwaul.js.base        = caterwaul();
  caterwaul.js.base.macros = [caterwaul.js.words, caterwaul.js.macros];
...
caterwaul.js.base(function ($) {
  $.anonymizer(symbols = arguments) = (translation_table[it] = gensym()) /over.symbols -then-
                                      given.node [node.replace(translation_table)] -where [translation_table = {}]})();
// Generated by SDoc 
