...
//   They all start with the same thing, so we drop the initial data and build conditionals on [0]. Here's the condition tree after partitioning (arity checks and intermediate variables elided):
