...
//     No 'break' statements are emitted because each branch is guaranteed to terminate with a 'return'. (If 'return false' is reached, it means that the macro didn't match.)
      ...
      partition_branch_template = parse('case _value: _statement; return false'),
...
//     Todo: encode actual invocations (blocking on multiple match handling, below)
...
//     success side-effects via return and a failure's side-effect is its continuation.
// Generated by SDoc 
