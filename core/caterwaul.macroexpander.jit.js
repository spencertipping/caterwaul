...
//     expensive; a new array cons isn't going to make much difference at that point.
      ...
      generate_path_reference_array = function (variables, paths) {for (var prs = [], i = 0, l = paths.length; i < l; ++i) prs.push(generate_path_reference(variables, paths[i]));
                                                                   return path_reference_array_template.replace({_elements: new syntax_node(',', prs).unflatten()})},
// Generated by SDoc 
