...
caterwaul.tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gms5vwmo_501zqy=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('precompiled_internal')),new caterwaul.syntax('_x'));
var gensym_1_gms5vwmo_501zqz=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax('_name')));
var gensym_1_gms5vwmo_501zr0=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax(',',new caterwaul.syntax('_name'),new caterwaul.syntax('_children'))));
var gensym_1_gms5vwmo_501zr1=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('clone')),new caterwaul.syntax('_string'));
...
return (((matches)&&(matches._gensym.data)))}).call(this)}),mark_as_compiled=(function (references,k,tree,environment){return ((k&&references[k])&&((function (it){return (references[k].compiled=tree,references[k].environment=environment),it}).call(this,((function (it){return (((references[k].compiled)&&((function (){throw new Error(('detected multiple compilations of '+(references[k].tree.serialize())+''))}).call(this)))),it}).call(this,(references[k]))))))}),wrapped_compile=(function (original,references){return (function (tree,environment){return (function (it){return (mark_as_compiled(references,function_key(tree),tree,caterwaul.merge({},this.globals,environment))),it}).call(this,(original.call(this,tree,environment)))})}),signal_already_compiled=(function (tree){return gensym_1_gms5vwmo_501zqy.replace({_x:tree})}),closure_template=caterwaul.parse('(function () {_vars; return (_value)}).call(this)'),closure_variable_template=caterwaul.parse('var _var = _value'),closure_null_template=caterwaul.parse('null'),escape_string=(function (s){return '\''+s.replace(/\\/g,'\\\\').replace(/\n/g,'\\n').replace(/'/g,'\\\'')+'\''}),caterwaul_ref_string=(function (configurations){return '\''+(function (){var gensym_1_gms5vwmo_501zqs=(configurations),gensym_1_gms5vwmo_501zqt=[];
for (var it in gensym_1_gms5vwmo_501zqs)Object.prototype.hasOwnProperty.call(gensym_1_gms5vwmo_501zqs,it)&&gensym_1_gms5vwmo_501zqt.push(it);
return gensym_1_gms5vwmo_501zqt}).call(this)+'\''}),serialize_syntax=(function (value){return value.length===0?gensym_1_gms5vwmo_501zqz.replace({_name:escape_string(value.data)}):(function (){var children=new caterwaul.syntax(',',(function (){for (var gensym_1_gms5vwmo_501zqo=(value),gensym_1_gms5vwmo_501zqp=[],gensym_1_gms5vwmo_501zqq=0,gensym_1_gms5vwmo_501zqr=gensym_1_gms5vwmo_501zqo.length,it;
gensym_1_gms5vwmo_501zqq<gensym_1_gms5vwmo_501zqr;
 ++gensym_1_gms5vwmo_501zqq)it=gensym_1_gms5vwmo_501zqo[gensym_1_gms5vwmo_501zqq],gensym_1_gms5vwmo_501zqp.push(serialize_syntax(it));
return gensym_1_gms5vwmo_501zqp}).call(this)).unflatten();
return (gensym_1_gms5vwmo_501zr0.replace({_name:escape_string(value.data),_children:children}))}).call(this)}),serialize_caterwaul=(function (value){return gensym_1_gms5vwmo_501zr1.replace({_string:caterwaul_ref_string(value.has)})}),serialize_ref=(function (value,name,seen){return  !value?(''+(value)+''):value.constructor===caterwaul.syntax?seen[value.id()]||(function (it){return (serialize_syntax(value))}).call(this,((seen[value.id()]=name))):value.is_caterwaul===caterwaul.is_caterwaul?seen[value.id()]||(function (it){return (serialize_caterwaul(value))}).call(this,((seen[value.id()]=name))):(function (){throw new Error(('syntax ref value is not serializable: '+(value)+''))}).call(this)}),single_variable=(function (name,value){return closure_variable_template.replace({_var:name,_value:value})}),names_and_values_for=(function (environment){return (function (){var gensym_1_gms5vwmo_501zqs=(environment),gensym_1_gms5vwmo_501zqt=[];
for (var it in gensym_1_gms5vwmo_501zqs)Object.prototype.hasOwnProperty.call(gensym_1_gms5vwmo_501zqs,it)&&gensym_1_gms5vwmo_501zqt.push(single_variable(it,environment[it]));
return gensym_1_gms5vwmo_501zqt}).call(this)}),tree_variables=(function (tree){return (function (){var vars=[],seen={};
...
caterwaul.tconfiguration('core.js core.words core.quote','core.trace',caterwaul.precompiled_internal((function (){var gensym_1_gms5vwmo_501zrd=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_expression'))));
var gensym_1_gms5vwmo_501zre=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_object')),new caterwaul.syntax('_method')),new caterwaul.syntax('[',new caterwaul.syntax('_parameters')))));
var gensym_1_gms5vwmo_501zrf=new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('_y'));
var gensym_1_gms5vwmo_501zrg=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('all'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gms5vwmo_501zrh=new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z'));
var gensym_1_gms5vwmo_501zri=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('all'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y'))),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gms5vwmo_501zrj=new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z'));
var gensym_1_gms5vwmo_501zrk=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('all'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('_y')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gms5vwmo_501zrl=new caterwaul.syntax('+',new caterwaul.syntax('_x'),new caterwaul.syntax('_y'));
var gensym_1_gms5vwmo_501zrm=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('all'),new caterwaul.syntax('+',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gms5vwmo_501zrn=new caterwaul.syntax('u+',new caterwaul.syntax('_x'));
var gensym_1_gms5vwmo_501zro=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('all'),new caterwaul.syntax('u+',new caterwaul.syntax('[]',new caterwaul.syntax('T'),new caterwaul.syntax('_x')))));
return (function (){(function (){var qw=(function (s){return s.split(/\s+/)}),trace_directive_aliases=(function (it){return ((function (){var o=it;
return ((function (){var gensym_1_gms5vwmo_501zr7=(o),gensym_1_gms5vwmo_501zr8=[];
for (var it in gensym_1_gms5vwmo_501zr7)Object.prototype.hasOwnProperty.call(gensym_1_gms5vwmo_501zr7,it)&&gensym_1_gms5vwmo_501zr8.push(o[o[it]]=it);
return gensym_1_gms5vwmo_501zr8}).call(this))}).call(this)),it}).call(this,((function (it){return ((function (){var o=it;
return ((function (){for (var gensym_1_gms5vwmo_501zr3=(qw('I D H S E')),gensym_1_gms5vwmo_501zr4=[],gensym_1_gms5vwmo_501zr5=0,gensym_1_gms5vwmo_501zr6=gensym_1_gms5vwmo_501zr3.length,it;
gensym_1_gms5vwmo_501zr5<gensym_1_gms5vwmo_501zr6;
 ++gensym_1_gms5vwmo_501zr5)it=gensym_1_gms5vwmo_501zr3[gensym_1_gms5vwmo_501zr5],gensym_1_gms5vwmo_501zr4.push(o[it]=this.gensym());
return gensym_1_gms5vwmo_501zr4}).call(this))}).call(this)),it}).call(this,({})))),convert_trace_directives_in=(function (tree){return caterwaul.ensure_syntax(tree).replace(trace_directive_aliases)}),with_tmacro=(function (){return this.method('tmacro',(function (lhs,rhs){return this.final_macro(lhs,convert_trace_directives_in(rhs))}))}),expression_hook_template=gensym_1_gms5vwmo_501zrd.as('('),indirect_method_hook_template=gensym_1_gms5vwmo_501zre.as('('),quote_method_name=(function (method){return ('"'+(method.data.replace(/"/g,"\\\""))+'"')});
return (this.shallow('trace_expression',this.global().clone(with_tmacro).configure(function (){this.method('assignment_operator',(function (op){return this.tmacro(gensym_1_gms5vwmo_501zrf.replace({'=':op}),gensym_1_gms5vwmo_501zrg.replace({'=':op})).tmacro(gensym_1_gms5vwmo_501zrh.replace({'=':op}),gensym_1_gms5vwmo_501zri.replace({'=':op})).tmacro(gensym_1_gms5vwmo_501zrj.replace({'=':op}),gensym_1_gms5vwmo_501zrk.replace({'=':op}))})).method('binary_operator',(function (op){return this.tmacro(gensym_1_gms5vwmo_501zrl.replace({'+':op}),gensym_1_gms5vwmo_501zrm.replace({'+':op}))})).method('unary_operator',(function (op){return this.tmacro(gensym_1_gms5vwmo_501zrn.replace({'u+':('u'+(op)+'')}),gensym_1_gms5vwmo_501zro.replace({'u+':('u'+(op)+'')}))})),this.tmacro('_x','H[_x, _x]').tmacro('(_x)','(E[_x])').tmacro('++_x','H[all, ++_x]').tmacro('--_x','H[all, --_x]').tmacro('_x++','H[all, _x++]').tmacro('_x--','H[all, _x--]').tmacro('_x, _y','E[_x], E[_y]').tmacro('_x._y','H[all, E[_x]._y]').tmacro('_o._m(_xs)','D[all, E[_o], _m, [E[_xs]]]').tmacro('_o[_m](_xs)','I[all, E[_o], E[_m], [E[_xs]]]').tmacro('typeof _x','H[all, typeof _x]').tmacro('void _x','H[all, void E[_x]]').tmacro('delete _x._y','H[all, delete E[_x]._y]').tmacro('new _x(_y)','H[all, new H[_x](E[_y])]').tmacro('{_ps}','H[all, {E[_ps]}]').tmacro('_k: _v','_k: E[_v]').tmacro('[_xs]','H[all, [E[_xs]]]').tmacro('_x ? _y : _z','H[all, E[_x] ? E[_y] : E[_z]]').tmacro('function (_xs) {_body}','H[all, function (_xs) {S[_body]}]'),(function (){for (var gensym_1_gms5vwmo_501zr3=(qw('= += -= *= /= %= &= |= ^= <<= >>= >>>=')),gensym_1_gms5vwmo_501zr4=[],gensym_1_gms5vwmo_501zr5=0,gensym_1_gms5vwmo_501zr6=gensym_1_gms5vwmo_501zr3.length,it;
gensym_1_gms5vwmo_501zr5<gensym_1_gms5vwmo_501zr6;
 ++gensym_1_gms5vwmo_501zr5)it=gensym_1_gms5vwmo_501zr3[gensym_1_gms5vwmo_501zr5],gensym_1_gms5vwmo_501zr4.push(this.assignment_operator(it));
return gensym_1_gms5vwmo_501zr4}).call(this),(function (){for (var gensym_1_gms5vwmo_501zr3=(qw('() [] + - * / % < > <= >= == != === !== in instanceof ^ & | && ||')),gensym_1_gms5vwmo_501zr4=[],gensym_1_gms5vwmo_501zr5=0,gensym_1_gms5vwmo_501zr6=gensym_1_gms5vwmo_501zr3.length,it;
gensym_1_gms5vwmo_501zr5<gensym_1_gms5vwmo_501zr6;
 ++gensym_1_gms5vwmo_501zr5)it=gensym_1_gms5vwmo_501zr3[gensym_1_gms5vwmo_501zr5],gensym_1_gms5vwmo_501zr4.push(this.binary_operator(it));
return gensym_1_gms5vwmo_501zr4}).call(this),(function (){for (var gensym_1_gms5vwmo_501zr3=(qw('+ - ! ~')),gensym_1_gms5vwmo_501zr4=[],gensym_1_gms5vwmo_501zr5=0,gensym_1_gms5vwmo_501zr6=gensym_1_gms5vwmo_501zr3.length,it;
gensym_1_gms5vwmo_501zr5<gensym_1_gms5vwmo_501zr6;
 ++gensym_1_gms5vwmo_501zr5)it=gensym_1_gms5vwmo_501zr3[gensym_1_gms5vwmo_501zr5],gensym_1_gms5vwmo_501zr4.push(this.unary_operator(it));
return gensym_1_gms5vwmo_501zr4}).call(this)})),this.shallow('trace_statement',this.global().clone(with_tmacro).configure(function (){this.tmacro('_x','E[_x]').tmacro('for (_x) _y','for (S[_x]) S[_y]').tmacro('{_x}','{S[_x]}').tmacro('for (_x; _y; _z) _body','for (S[_x]; E[_y]; E[_z]) S[_body]').tmacro('_x; _y','S[_x]; S[_y]').tmacro('while (_x) _y','while (E[_x]) S[_y]').tmacro('do _x; while (_y)','do S[_x]; while (E[_y])').tmacro('function _f(_args) {_body}','function _f(_args) {S[_body]}').tmacro('do {_x} while (_y)','do {S[_x]} while (E[_y])').tmacro('_x, _y','S[_x], S[_y]').tmacro('_x = _y','_x = E[_y]').tmacro('try {_x} catch (_e) {_y}','try {S[_x]} catch (_e) {S[_y]}').tmacro('var _xs','var S[_xs]').tmacro('try {_x} catch (_e) {_y} finally {_z}','try {S[_x]} catch (_e) {S[_y]} finally {S[_z]}').tmacro('const _xs','const S[_xs]').tmacro('try {_x} finally {_y}','try {S[_x]} finally {S[_y]}').tmacro('if (_x) _y','if (E[_x]) S[_y]').tmacro('return _x','return E[_x]').tmacro('if (_x) _y; else _z','if (E[_x]) S[_y]; else S[_z]').tmacro('return','return').tmacro('if (_x) {_y} else _z','if (E[_x]) {S[_y]} else S[_z]').tmacro('throw _x','throw E[_x]').tmacro('break _label','break _label').tmacro('switch (_c) {_body}','switch (E[_c]) {S[_body]}').tmacro('break','break').tmacro('with (_x) _y','with (E[_x]) S[_y]').tmacro('continue _label','continue _label').tmacro('continue','continue').tmacro('_label: _stuff','_label: S[_stuff]')})),this.shallow('trace_directive_expander',this.global().clone().configure(function (){this.event('before_trace','after_trace'),this.method('tmacro',(function (lhs,rhs){return this.macro(convert_trace_directives_in(lhs),rhs)})).tmacro('H[_tree, _x]',(function (match){return this.expression_hook(match._tree,match._x)})).tmacro('D[_tree, _object, _method, [_parameters]]',(function (match){return this.direct_method_hook(match._tree,match)})).tmacro('I[_tree, _object, _method, [_parameters]]',(function (match){return this.indirect_method_hook(match._tree,match)})).tmacro('E[_x]',(function (match){return this.expression(match._x)})).tmacro('S[_x]',(function (match){return this.statement(match._x)})),this.method('before_hook',(function (tree){return this.before_trace(tree)})).method('after_hook',(function (tree,value){return (function (it){return (value)}).call(this,(this.after_trace(tree,value)))})).method('after_method_hook',(function (tree,object,method,parameters){return (function (){var resolved=object[method];
return ((function (it){return (this.after_hook(tree,resolved.apply(object,parameters)))}).call(this,((function (it){return (this.after_trace(tree[0],resolved))}).call(this,(this.before_trace(tree[0]))))))}).call(this)})).once('before_hook_ref',(function (nothing){return new this.ref(this.before_hook)})).once('after_hook_ref',(function (nothing){return new this.ref(this.after_hook)})).once('after_method_hook_ref',(function (nothing){return new this.ref(this.after_method_hook)})).method('expression_hook',(function (original,tree){return expression_hook_template.replace({_before_hook:this.before_hook_ref(),_after_hook:this.after_hook_ref(),_tree:new this.ref(original),_expression:tree.as('(')})})).method('method_hook',(function (tree,object,method,parameters){return indirect_method_hook_template.replace({_before_hook:this.before_hook_ref(),_after_hook:this.after_method_hook_ref(),_tree:new this.ref(tree),_object:object,_method:method,_parameters:parameters})})).method('direct_method_hook',(function (tree,match){return this.method_hook(tree,match._object,quote_method_name(match._method),match._parameters)})).method('indirect_method_hook',(function (tree,match){return this.method_hook(tree,match._object,match._method,match._parameters)}))})),this.event('before_trace','after_trace'),this.trace_directive_expander.on_before_trace(this.before_trace),this.trace_directive_expander.on_after_trace(this.after_trace),this.trace_directive_expander.field('statement',this.trace_statement),this.trace_directive_expander.field('expression',this.trace_expression),this.trace_statement.after(this.trace_directive_expander),this.trace_expression.after(this.trace_directive_expander),this.on_bake((function (nothing){return (function (it){return (this.trace_directive_expander.bake())}).call(this,((function (it){return (this.trace_statement.bake())}).call(this,(this.trace_expression.bake()))))})),this.after(this.trace_statement))}).call(this)})}).call(this)));
