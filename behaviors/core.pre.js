...
caterwaul.tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmyauqu3_a1bdcw=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('precompiled_internal')),new caterwaul.syntax('_x'));
var gensym_1_gmyauqu3_a1bdcx=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax('_name')));
var gensym_1_gmyauqu3_a1bdcy=new caterwaul.syntax('new',new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('syntax')),new caterwaul.syntax(',',new caterwaul.syntax('_name'),new caterwaul.syntax('_children'))));
var gensym_1_gmyauqu3_a1bdcz=new caterwaul.syntax('()',new caterwaul.syntax('.',new caterwaul.syntax('caterwaul'),new caterwaul.syntax('clone')),new caterwaul.syntax('_string'));
...
return (((matches)&&(matches._gensym.data)))}).call(this)}),mark_as_compiled=(function (references,k,tree,environment){return ((k&&references[k])&&((function (it){return (references[k].compiled=tree,references[k].environment=environment),it}).call(this,((function (it){return (((references[k].compiled)&&((function (){throw new Error(('detected multiple compilations of '+(references[k].tree.serialize())+''))}).call(this)))),it}).call(this,(references[k]))))))}),wrapped_compile=(function (original,references){return (function (tree,environment){return (function (it){return (mark_as_compiled(references,function_key(tree),tree,caterwaul.merge({},this.globals,environment))),it}).call(this,(original.call(this,tree,environment)))})}),signal_already_compiled=(function (tree){return gensym_1_gmyauqu3_a1bdcw.replace({_x:tree})}),closure_template=caterwaul.parse('(function () {_vars; return (_value)}).call(this)'),closure_variable_template=caterwaul.parse('var _var = _value'),closure_null_template=caterwaul.parse('null'),escape_string=(function (s){return '\''+s.replace(/\\/g,'\\\\').replace(/\n/g,'\\n').replace(/'/g,'\\\'')+'\''}),caterwaul_ref_string=(function (configurations){return '\''+(function (){var gensym_1_gmyauqu3_a1bdcq=(configurations),gensym_1_gmyauqu3_a1bdcr=[];
for (var it in gensym_1_gmyauqu3_a1bdcq)Object.prototype.hasOwnProperty.call(gensym_1_gmyauqu3_a1bdcq,it)&&gensym_1_gmyauqu3_a1bdcr.push(it);
return gensym_1_gmyauqu3_a1bdcr}).call(this)+'\''}),serialize_syntax=(function (value){return value.length===0?gensym_1_gmyauqu3_a1bdcx.replace({_name:escape_string(value.data)}):(function (){var children=new caterwaul.syntax(',',(function (){for (var gensym_1_gmyauqu3_a1bdcm=(value),gensym_1_gmyauqu3_a1bdcn=[],gensym_1_gmyauqu3_a1bdco=0,gensym_1_gmyauqu3_a1bdcp=gensym_1_gmyauqu3_a1bdcm.length,it;
gensym_1_gmyauqu3_a1bdco<gensym_1_gmyauqu3_a1bdcp;
 ++gensym_1_gmyauqu3_a1bdco)it=gensym_1_gmyauqu3_a1bdcm[gensym_1_gmyauqu3_a1bdco],gensym_1_gmyauqu3_a1bdcn.push(serialize_syntax(it));
return gensym_1_gmyauqu3_a1bdcn}).call(this)).unflatten();
return (gensym_1_gmyauqu3_a1bdcy.replace({_name:escape_string(value.data),_children:children}))}).call(this)}),serialize_caterwaul=(function (value){return gensym_1_gmyauqu3_a1bdcz.replace({_string:caterwaul_ref_string(value.has)})}),serialize_ref=(function (value,name,seen){return  !value?(''+(value)+''):value.constructor===caterwaul.syntax?seen[value.id()]||(function (it){return (serialize_syntax(value))}).call(this,((seen[value.id()]=name))):value.is_caterwaul===caterwaul.is_caterwaul?seen[value.id()]||(function (it){return (serialize_caterwaul(value))}).call(this,((seen[value.id()]=name))):(function (){throw new Error(('syntax ref value is not serializable: '+(value)+''))}).call(this)}),single_variable=(function (name,value){return closure_variable_template.replace({_var:name,_value:value})}),names_and_values_for=(function (environment){return (function (){var gensym_1_gmyauqu3_a1bdcq=(environment),gensym_1_gmyauqu3_a1bdcr=[];
for (var it in gensym_1_gmyauqu3_a1bdcq)Object.prototype.hasOwnProperty.call(gensym_1_gmyauqu3_a1bdcq,it)&&gensym_1_gmyauqu3_a1bdcr.push(single_variable(it,environment[it]));
return gensym_1_gmyauqu3_a1bdcr}).call(this)}),tree_variables=(function (tree){return (function (){var vars=[],seen={};
...
caterwaul.shallow('trace',caterwaul.clone().tconfigure('core.js core.words core.quote',caterwaul.precompiled_internal((function (){var gensym_1_gmyauqu3_a1bddm=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmyauqu3_a1bddn=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('_x'),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmyauqu3_a1bddo=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmyauqu3_a1bddp=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('[]',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y'))),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmyauqu3_a1bddq=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')),new caterwaul.syntax('_z')));
var gensym_1_gmyauqu3_a1bddr=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('=',new caterwaul.syntax('.',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('_y')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_z')))));
var gensym_1_gmyauqu3_a1bdds=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('+',new caterwaul.syntax('_x'),new caterwaul.syntax('_y')));
var gensym_1_gmyauqu3_a1bddt=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('+',new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_x')),new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('_y')))));
var gensym_1_gmyauqu3_a1bddu=new caterwaul.syntax('[]',new caterwaul.syntax('E'),new caterwaul.syntax('u+',new caterwaul.syntax('_x')));
var gensym_1_gmyauqu3_a1bddv=new caterwaul.syntax('[]',new caterwaul.syntax('H'),new caterwaul.syntax(',',new caterwaul.syntax('_'),new caterwaul.syntax('u+',new caterwaul.syntax('[]',new caterwaul.syntax('T'),new caterwaul.syntax('_x')))));
var gensym_1_gmyauqu3_a1bddw=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_expression'))));
var gensym_1_gmyauqu3_a1bddx=new caterwaul.syntax(',',new caterwaul.syntax('()',new caterwaul.syntax('_before_hook'),new caterwaul.syntax('_tree')),new caterwaul.syntax('()',new caterwaul.syntax('_after_hook'),new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax(',',new caterwaul.syntax('_tree'),new caterwaul.syntax('_object')),new caterwaul.syntax('_method')),new caterwaul.syntax('[',new caterwaul.syntax('_parameters')))));
return (function (){(function (){var qw=(function (s){return s.split(/\s+/)});
return (this.event('before_trace','after_trace'),(function (){for (var gensym_1_gmyauqu3_a1bddc=(qw('E S H D I')),gensym_1_gmyauqu3_a1bddd=[],gensym_1_gmyauqu3_a1bdde=0,gensym_1_gmyauqu3_a1bddf=gensym_1_gmyauqu3_a1bddc.length,it;
gensym_1_gmyauqu3_a1bdde<gensym_1_gmyauqu3_a1bddf;
 ++gensym_1_gmyauqu3_a1bdde)it=gensym_1_gmyauqu3_a1bddc[gensym_1_gmyauqu3_a1bdde],gensym_1_gmyauqu3_a1bddd.push(this.state_marker(it));
return gensym_1_gmyauqu3_a1bddd}).call(this),this.method('assignment_operator',(function (op){return this.tmacro(gensym_1_gmyauqu3_a1bddm.replace({'=':op}),gensym_1_gmyauqu3_a1bddn.replace({'=':op})).tmacro(gensym_1_gmyauqu3_a1bddo.replace({'=':op}),gensym_1_gmyauqu3_a1bddp.replace({'=':op})).tmacro(gensym_1_gmyauqu3_a1bddq.replace({'=':op}),gensym_1_gmyauqu3_a1bddr.replace({'=':op}))})).method('binary_operator',(function (op){return this.tmacro(gensym_1_gmyauqu3_a1bdds.replace({'+':op}),gensym_1_gmyauqu3_a1bddt.replace({'+':op}))})).method('unary_operator',(function (op){return this.tmacro(gensym_1_gmyauqu3_a1bddu.replace({'u+':('u'+(op)+'')}),gensym_1_gmyauqu3_a1bddv.replace({'u+':('u'+(op)+'')}))})),this.tmacro('E[]','null').tmacro('E[_x]','H[_, _x]'),(function (){for (var gensym_1_gmyauqu3_a1bddc=(qw('= += -= *= /= %= &= |= ^= <<= >>= >>>=')),gensym_1_gmyauqu3_a1bddd=[],gensym_1_gmyauqu3_a1bdde=0,gensym_1_gmyauqu3_a1bddf=gensym_1_gmyauqu3_a1bddc.length,it;
gensym_1_gmyauqu3_a1bdde<gensym_1_gmyauqu3_a1bddf;
 ++gensym_1_gmyauqu3_a1bdde)it=gensym_1_gmyauqu3_a1bddc[gensym_1_gmyauqu3_a1bdde],gensym_1_gmyauqu3_a1bddd.push(this.assignment_operator(it));
return gensym_1_gmyauqu3_a1bddd}).call(this),(function (){for (var gensym_1_gmyauqu3_a1bddc=(qw('() [] + - * / % < > <= >= == != === !== in instanceof ^ & | && ||')),gensym_1_gmyauqu3_a1bddd=[],gensym_1_gmyauqu3_a1bdde=0,gensym_1_gmyauqu3_a1bddf=gensym_1_gmyauqu3_a1bddc.length,it;
gensym_1_gmyauqu3_a1bdde<gensym_1_gmyauqu3_a1bddf;
 ++gensym_1_gmyauqu3_a1bdde)it=gensym_1_gmyauqu3_a1bddc[gensym_1_gmyauqu3_a1bdde],gensym_1_gmyauqu3_a1bddd.push(this.binary_operator(it));
return gensym_1_gmyauqu3_a1bddd}).call(this),(function (){for (var gensym_1_gmyauqu3_a1bddc=(qw('+ - ! ~')),gensym_1_gmyauqu3_a1bddd=[],gensym_1_gmyauqu3_a1bdde=0,gensym_1_gmyauqu3_a1bddf=gensym_1_gmyauqu3_a1bddc.length,it;
gensym_1_gmyauqu3_a1bdde<gensym_1_gmyauqu3_a1bddf;
 ++gensym_1_gmyauqu3_a1bdde)it=gensym_1_gmyauqu3_a1bddc[gensym_1_gmyauqu3_a1bdde],gensym_1_gmyauqu3_a1bddd.push(this.unary_operator(it));
return gensym_1_gmyauqu3_a1bddd}).call(this),this.tmacro('E[(_x)]','(E[_x])').tmacro('E[++_x]','H[_, ++_x]').tmacro('E[--_x]','H[_, --_x]').tmacro('E[_x++]','H[_, _x++]').tmacro('E[_x--]','H[_, _x--]').tmacro('E[_x, _y]','E[_x], E[_y]').tmacro('E[_x._y]','H[_, E[_x]._y]').tmacro('E[_f()]','H[_, E[_f]()]').tmacro('E[_o._m(_xs)]','D[_, E[_o], _m, [E[_xs]]]').tmacro('E[_o[_m](_xs)]','I[_, E[_o], E[_m], [E[_xs]]]').tmacro('E[_o._m()]','D[_, E[_o], _m, []').tmacro('E[_o[_m]()]','I[_, E[_o], E[_m], []').tmacro('E[typeof _x]','H[_, typeof _x]').tmacro('E[void _x]','H[_, void E[_x]]').tmacro('E[delete _x._y]','H[_, delete E[_x]._y]').tmacro('E[new _x(_y)]','H[_, new H[_x](E[_y])]').tmacro('E[{_ps}]','H[_, {E[_ps]}]').tmacro('E[_k: _v]','_k: E[_v]').tmacro('E[[_xs]]','H[_, [E[_xs]]]').tmacro('E[_x ? _y : _z]','H[_, E[_x] ? E[_y] : E[_z]]').tmacro('E[function (_xs) {_body}]','H[_, function (_xs) {S[_body]}]').tmacro('E[function ()    {_body}]','H[_, function ()    {S[_body]}]'),this.tmacro('S[_x]','E[_x]').tmacro('S[for (_x) _y]','for (S[_x]) S[_y]').tmacro('S[{_x}]','{S[_x]}').tmacro('S[for (_x; _y; _z) _body]','for (S[_x]; E[_y]; E[_z]) S[_body]').tmacro('S[_x; _y]','S[_x]; S[_y]').tmacro('S[while (_x) _y]','while (E[_x]) S[_y]').tmacro('S[do _x; while (_y)]','do S[_x]; while (E[_y])').tmacro('S[function _f(_args) {_body}]','function _f(_args) {S[_body]}').tmacro('S[do {_x} while (_y)]','do {S[_x]} while (E[_y])').tmacro('S[function _f()      {_body}]','function _f()      {S[_body]}').tmacro('S[_x, _y]','S[_x], S[_y]').tmacro('S[try {_x} catch (_e) {_y}]','try {S[_x]} catch (_e) {S[_y]}').tmacro('S[_x = _y]','_x = E[_y]').tmacro('S[try {_x} catch (_e) {_y} finally {_z}]','try {S[_x]} catch (_e) {S[_y]} finally {S[_z]}').tmacro('S[var _xs]','var S[_xs]').tmacro('S[try {_x} finally {_y}]','try {S[_x]} finally {S[_y]}').tmacro('S[const _xs]','const S[_xs]').tmacro('S[return _x]','return E[_x]').tmacro('S[if (_x) _y]','if (E[_x]) S[_y]').tmacro('S[return]','return').tmacro('S[if (_x) _y; else _z]','if (E[_x]) S[_y]; else S[_z]').tmacro('S[throw _x]','throw E[_x]').tmacro('S[if (_x) {_y} else _z]','if (E[_x]) {S[_y]} else S[_z]').tmacro('S[break _label]','break _label').tmacro('S[break]','break').tmacro('S[switch (_c) {_body}]','switch (E[_c]) {S[_body]}').tmacro('S[continue _label]','continue _label').tmacro('S[with (_x) _y]','with (E[_x]) S[_y]').tmacro('S[continue]','continue').tmacro('S[_label: _stuff]','_label: S[_stuff]'),this.tmacro('H[_tree, _x]',(function (match){return this.expression_hook(match._tree[1],match._x)})).tmacro('D[_tree, _object, _method, [_parameters]]',(function (match){return this.direct_method_hook(match._tree[1],match)})).tmacro('I[_tree, _object, _method, [_parameters]]',(function (match){return this.indirect_method_hook(match._tree[1],match)})),this.method('before_hook',(function (tree){return this.before_trace(tree)})).method('after_hook',(function (tree,value){return (function (it){return (value)}).call(this,(this.after_trace(tree,value)))})).method('after_method_hook',(function (tree,object,method,parameters){return (function (){var resolved=object[method];
return ((function (it){return (this.after_hook(tree,resolved.apply(object,parameters)))}).call(this,((function (it){return (this.after_trace(tree[0],resolved))}).call(this,(this.before_trace(tree[0]))))))}).call(this)})).once('before_hook_ref',(function (nothing){return new this.ref(this.before_hook)})).once('after_hook_ref',(function (nothing){return new this.ref(this.after_hook)})).once('after_method_hook_ref',(function (nothing){return new this.ref(this.after_method_hook)})).method('quote_method_name',(function (method){return ('"'+(method.data.replace(/"/g,"\\\""))+'"')})).field('expression_hook_template',gensym_1_gmyauqu3_a1bddw.as('(')).field('indirect_method_hook_template',gensym_1_gmyauqu3_a1bddx.as('(')).method('expression_hook',(function (original,tree){return this.expression_hook_template.replace({_before_hook:this.before_hook_ref(),_after_hook:this.after_hook_ref(),_tree:new this.ref(original),_expression:tree.as('(')})})).method('method_hook',(function (tree,object,method,parameters){return this.indirect_method_hook_template.replace({_before_hook:this.before_hook_ref(),_after_hook:this.after_method_hook_ref(),_tree:new this.ref(tree),_object:object,_method:method,_parameters:parameters})})).method('direct_method_hook',(function (tree,match){return this.method_hook(tree,match._object,this.quote_method_name(match._method),match._parameters)})).method('indirect_method_hook',(function (tree,match){return this.method_hook(tree,match._object,match._method,match._parameters)})),this.initial_state('S'))}).call(this)})}).call(this))));
