...
caterwaul.tconfiguration('std.qs std.fn std.bind','macro.defmacro',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2ao1_4m74tv=caterwaul.parse('defmacro[_][_]');
var gensym_2_gmjq2ao1_4m74tw=caterwaul.parse('null');
var gensym_2_gmjq2ao1_4m74tx=caterwaul.parse('defsubst[_][_]');
var gensym_2_gmjq2ao1_4m74ty=caterwaul.parse('null');
return (function (gensym_2_gmjq2ao1_4m74tq){(function (wildcard){return this.macro(gensym_2_gmjq2ao1_4m74tv,(function (pattern,expansion){return this.rmacro(pattern,this.compile(this.macroexpand(expansion))),gensym_2_gmjq2ao1_4m74tw})).macro(gensym_2_gmjq2ao1_4m74tx,(function (pattern,expansion){return this.rmacro(pattern.rmap(wildcard),(function (wildcards){return (function (){return (function (hash,as){return this.util.map((function (v,i){return hash[v.data]=as[i]}),wildcards),expansion.replace(hash)}).call(this,{},arguments)})}).call(this,pattern.collect(wildcard))),gensym_2_gmjq2ao1_4m74ty}))}).call(this,(function (n){return n.data.constructor===String&&n.data.charAt(0)==='_'&&'_'}))})})())).tconfiguration('std.qs std.fn std.bind','macro.with_gensyms',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2ao1_4m74u0=caterwaul.parse('with_gensyms[_][_]');
var gensym_2_gmjq2ao1_4m74u2=caterwaul.parse('qs[_]');
return (function (gensym_2_gmjq2ao1_4m74tr){this.rmacro(gensym_2_gmjq2ao1_4m74u0,(function (vars,expansion){return (function (bindings){return vars.flatten(',').each((function (gensym_2_gmjq2ao1_4m74u1){return (function (){return (function (v){return bindings[v.data]=this.gensym()}).apply(gensym_2_gmjq2ao1_4m74u1,arguments)})})(this)),gensym_2_gmjq2ao1_4m74u2.replace({_:expansion.replace(bindings)})}).call(this,{})}))})})())).tconfiguration('std.qs std.fn','macro.compile_eval',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2ao1_4m74u4=caterwaul.parse('compile_eval[_]');
var gensym_2_gmjq2ao1_4m74u5=caterwaul.parse('fn_[_]');
return (function (gensym_2_gmjq2ao1_4m74ts){this.macro(gensym_2_gmjq2ao1_4m74u4,(function (e){return new this.ref(this.compile(this.macroexpand(gensym_2_gmjq2ao1_4m74u5.replace({_:e}))).call(this))}))})})())).configuration('macro',function (gensym_2_gmjq2ao1_4m74tt){this.configure('macro.defmacro macro.with_gensyms macro.compile_eval')});





caterwaul.tconfiguration('std macro','opt.unroll',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2e1o_762k1n=caterwaul.parse('opt.unroll[_,_][_]');
var gensym_2_gmjq2e1o_762k1s=caterwaul.parse('qg[function (gensym_2_gmjq2e1o_762k1o,gensym_2_gmjq2e1o_762k1k){for (var gensym_2_gmjq2e1o_762k1p=gensym_2_gmjq2e1o_762k1o>=0&&gensym_2_gmjq2e1o_762k1o>>3,gensym_2_gmjq2e1o_762k1q=gensym_2_gmjq2e1o_762k1o>=0&&gensym_2_gmjq2e1o_762k1o&7,_i_=0;\n_i_<gensym_2_gmjq2e1o_762k1q;\n ++_i_)_body_;\nfor (var gensym_2_gmjq2e1o_762k1r=0;\ngensym_2_gmjq2e1o_762k1r<gensym_2_gmjq2e1o_762k1p;\n ++gensym_2_gmjq2e1o_762k1r){_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++;\n_body_;\n_i_++};\nreturn gensym_2_gmjq2e1o_762k1o}].call(this,_iterations_)');
return (function (gensym_2_gmjq2e1o_762k1j){this.rmacro(gensym_2_gmjq2e1o_762k1n,(function (variable,iterations,body){return gensym_2_gmjq2e1o_762k1s.replace({_i_:variable,_body_:body,_iterations_:iterations})}))})})()));
caterwaul.configuration('opt',function (gensym_2_gmjq2e1o_762k1l){this.configure('opt.unroll')});
...
return (function (gensym_2_gmjq2hz8_g3kder){this.shallow('seq',{core:((function (_){return _.prototype=((function (p){return p.constructor=_,p})).call(this,[]),_})).call(this,(function (){return null}))})})})())).tconfiguration('std opt continuation','seq.finite.core',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdes){this.configure('seq.core').seq.finite=((function (c){return c.prototype=((function (_){return _.size=(function (){return this.l||this.length}),_.slice=(function (){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)_.push(this[i]);
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){_.push(this[i]);
i++;
_.push(this[i]);
i++;
_.push(this[i]);
...
_.push(this[i]);
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,this.size()),_})).call(this,[])}),_.constructor=c,_})).call(this,new this.seq.core()),c})).call(this,((function (xs){return this.length=this.l=xs?(function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)this[i]=xs[i];
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){this[i]=xs[i];
i++;
this[i]=xs[i];
i++;
this[i]=xs[i];
...
this[i]=xs[i];
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,xs.size?xs.size():xs.length):0,undefined})))})})())).tconfiguration('std opt continuation','seq.finite.serialization',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdet){((function (_){return _.toString=(function (){return ('seq['+(this.slice().join(", "))+']')}),_.join=(function (x){return this.slice().join(x)}),_})).call(this,this.configure('seq.finite.core').seq.finite.prototype)})})())).tconfiguration('std opt continuation','seq.finite.mutability',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdeu){(function (push,slice){return ((function (_){return _.push=(function (){return (function (as){return ((function (_){return this.length=this.l,this})).call(this,(function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)this[this.l++]=as[i];
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){this[this.l++]=as[i];
i++;
this[this.l++]=as[i];
i++;
this[this.l++]=as[i];
...
this[this.l++]=as[i];
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,as.length))}).call(this,arguments)}),_.pop=(function (){return ((function (_){return delete this[this.length=this.l],_})).call(this,this[ --this.l])}),_.concat=(function (xs){return ((function (_){return _.push.apply(_,slice.call(xs)),_})).call(this,new this.constructor(this))}),_})).call(this,this.configure('seq.finite.core').seq.finite.prototype)}).call(this,Array.prototype.push,Array.prototype.slice)})})())).tconfiguration('std opt continuation','seq.finite.object',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdev){(function (own){return ((function (_){return _.keys=(function (o,all){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kdew){for (var k in o)if (all||own.call(o,k))_.push(k)})(),_})).call(this,new _())}),_.values=(function (o,all){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kdex){for (var k in o)if (all||own.call(o,k))_.push(o[k])})(),_})).call(this,new _())}),_.pairs=(function (o,all){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kdey){for (var k in o)if (all||own.call(o,k))_.push([k,o[k]])})(),_})).call(this,new _())}),_.prototype.object=(function (o){return ((function (_){return this.each((function (p){return _[p[0]]=p[1]})),_})).call(this,(o||{}))}),_})).call(this,this.configure('seq.finite.core').seq.finite)}).call(this,Object.prototype.hasOwnProperty)})})())).tconfiguration('std opt continuation','seq.finite.traversal',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdez){((function (_){return _.map=(function (f){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)_.push(f.call(this,this[i],i));
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){_.push(f.call(this,this[i],i));
i++;
...
_.push(f.call(this,this[i],i));
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,this.l),_})).call(this,new this.constructor())}),_.filter=(function (f){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)(f.call(this,this[i],i))&&(_.push(this[i]));
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){(f.call(this,this[i],i))&&(_.push(this[i]));
i++;
...
(f.call(this,this[i],i))&&(_.push(this[i]));
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,this.l),_})).call(this,new this.constructor())}),_.each=(function (f){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)f.call(_,_[i],i);
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){f.call(_,_[i],i);
i++;
f.call(_,_[i],i);
i++;
f.call(_,_[i],i);
...
f.call(_,_[i],i);
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,_.l),_})).call(this,this)}),_.reversed=(function (){return ((function (_){return (function (l){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)_.push(this[l-i-1]);
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){_.push(this[l-i-1]);
i++;
_.push(this[l-i-1]);
i++;
_.push(this[l-i-1]);
...
_.push(this[l-i-1]);
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,l)}).call(this,this.l),_})).call(this,new this.constructor())}),_.flat_map=(function (f){return ((function (_){return this.each((function (x,xi){return (((function (xs){return xs.each?xs:new this.constructor(xs)})).call(this,f.call(this,x,xi))).each((function (x){return _.push(x)}))})),_})).call(this,new this.constructor())}),_.foldl=(function (f,x){return (function (x,xi){return (this.l>=xi)&&((function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)x=f.call(this,x,this[i+xi],i+xi);
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){x=f.call(this,x,this[i+xi],i+xi);
i++;
...
x=f.call(this,x,this[i+xi],i+xi);
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,this.l-xi),x)}).call(this,arguments.length>1?x:this[0],2-arguments.length)}),_.foldr=(function (f,x){return (function (x,xi,l){return (l>=xi-1)&&((function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)x=f.call(this,this[l-(i+xi)],x,l-(i+xi));
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){x=f.call(this,this[l-(i+xi)],x,l-(i+xi));
i++;
...
x=f.call(this,this[l-(i+xi)],x,l-(i+xi));
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,l-(xi-1)),x)}).call(this,arguments.length>1?x:this[this.l-1],3-arguments.length,this.l)}),_})).call(this,this.configure('seq.finite.core seq.finite.mutability').seq.finite.prototype)})})())).tconfiguration('std opt continuation','seq.finite.zip',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2hz8_g3kdfg=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2hz8_g3kdf0){((function (_){return (function (seq,slice){return _.prototype.zip=(function (){return (function (as,options){return (as[as.size()-1].constructor===Object)&&(gensym_2_gmjq2hz8_g3kdfg.util.merge(options,as.pop())),(function (l,f){return ((function (_){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)_.push(f.apply({i:i},as.map((function (x){return x[i]})).slice()));
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){_.push(f.apply({i:i},as.map((function (x){return x[i]})).slice()));
i++;
...
_.push(f.apply({i:i},as.map((function (x){return x[i]})).slice()));
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,l),_})).call(this,new this.constructor())}).call(this,as.map((function (x){return x.size?x.size():x.length})).foldl(options.outer?(function (x,y){return Math.max(x,y)}):(function (x,y){return Math.min(x,y)})),options.f)}).call(this,new seq([this].concat(slice.call(arguments))),{f:(function (){return new seq(arguments)}),outer:false})})}).call(this,_,Array.prototype.slice),_})).call(this,this.configure('seq.finite.traversal').seq.finite)})})())).tconfiguration('std opt continuation','seq.finite.quantification',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2hz8_g3kdfi=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2hz8_g3kdf1){((function (_){return _.exists=(function (f){return (gensym_2_gmjq2hz8_g3kdfi.continuation.call_cc.call(this,(function (gensym_2_gmjq2hz8_g3kdfj){return (function (){return (function (cc){return (function (gensym_2_gmjq2hz8_g3kd9g){for (var gensym_2_gmjq2hz8_g3kd9h=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g>>3,gensym_2_gmjq2hz8_g3kd9i=gensym_2_gmjq2hz8_g3kd9g>=0&&gensym_2_gmjq2hz8_g3kd9g&7,i=0;
i<gensym_2_gmjq2hz8_g3kd9i;
 ++i)((function (_){return _&&cc(_)})).call(this,f.call(this,this[i],i));
for (var gensym_2_gmjq2hz8_g3kd9j=0;
gensym_2_gmjq2hz8_g3kd9j<gensym_2_gmjq2hz8_g3kd9h;
 ++gensym_2_gmjq2hz8_g3kd9j){((function (_){return _&&cc(_)})).call(this,f.call(this,this[i],i));
i++;
...
((function (_){return _&&cc(_)})).call(this,f.call(this,this[i],i));
i++};
return gensym_2_gmjq2hz8_g3kd9g}).call(this,this.l),false}).apply(gensym_2_gmjq2hz8_g3kdfj,arguments)})})(this)))}),_.forall=(function (f){return  !this.exists((function (){return  !f.apply(this,arguments)}))}),_})).call(this,this.configure('seq.finite.core').seq.finite.prototype)})})())).tconfiguration('std opt continuation','seq.infinite.core',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdf2){this.configure('seq.core').seq.infinite=((function (_){return (function (i){return _.def=(function (name,ctor,h,t){return i[name]=((function (_){return _.prototype=((function (_){return _.h=h,_.t=t,_.constructor=ctor,_})).call(this,new i()),_})).call(this,ctor)})}).call(this,_),_.def('cons',(function (h,t){return this._h=h,this._t=t}),(function (){return this._h}),(function (){return this._t})),_.def('k',(function (x){return this._x=x}),(function (){return this._x}),(function (){return this})),_})).call(this,((function (_){return (function (ctor){return _.prototype=((function (_){return _.constructor=ctor,_})).call(this,new this.seq.core())}).call(this,_),_})).call(this,(function (){return null})))})})())).tconfiguration('std opt continuation','seq.infinite.y',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdf3){this.configure('seq.infinite.core').seq.infinite.def('y',((function (f,x){return this._f=f,this._x=x,undefined})),(function (){return this._x}),(function (){return new this.constructor(this._f,this._f(this._x))}))})})())).tconfiguration('std opt continuation','seq.infinite.transform',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2hz8_g3kdfn=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2hz8_g3kdfo=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2hz8_g3kdf4){((function (_){return _.prototype.map=(function (f){return new _.map(f,this)}),_.def('map',((function (f,xs){return this._f=f,this._xs=xs,undefined})),(function (){return this._f(this._xs.h())}),(function (){return new this.constructor(this._f,this._xs.t())})),_.prototype.filter=(function (f){return new _.filter(f,this)}),_.def('filter',((function (f,xs){return this._f=f,this._xs=(function (){var next=(function (s){return (function (cc){return f(s.h())?cc(s):(gensym_2_gmjq2hz8_g3kdfn.continuation.call_tail.call(next(s.t()),cc))})});
return (gensym_2_gmjq2hz8_g3kdfo.continuation.call_cc.call(this,next(xs)))}).call(this),undefined})),(function (){return this._xs.h()}),(function (){return new this.constructor(this._f,this._xs.t())})),_})).call(this,this.configure('seq.infinite.core').seq.infinite)})})())).tconfiguration('std opt continuation','seq.infinite.traversal',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2hz8_g3kdfq=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2hz8_g3kdfr=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2hz8_g3kdfs=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2hz8_g3kdft=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2hz8_g3kdf5){(function (finite){return ((function (_){return _.drop=(function (f){return (function (){var next=(function (s){return (function (cc){return f(s.h())?(gensym_2_gmjq2hz8_g3kdfq.continuation.call_tail.call(next(s.t()),cc)):cc(s)})});
return (gensym_2_gmjq2hz8_g3kdfr.continuation.call_cc.call(this,next(this)))}).call(this)}),_.take=(function (f){return (function (){var xs=new finite(),next=(function (s){return (function (cc){return (function (h){return f(h)?(xs.push(h),(gensym_2_gmjq2hz8_g3kdfs.continuation.call_tail.call(next(s.t()),cc))):cc(xs)}).call(this,s.h())})});
return (gensym_2_gmjq2hz8_g3kdft.continuation.call_cc.call(this,next(this)))}).call(this)}),_})).call(this,this.configure('seq.infinite.core').seq.infinite.prototype)}).call(this,this.configure('seq.finite.core seq.finite.mutability').seq.finite)})})())).tconfiguration('std opt continuation','seq.numeric',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2hz8_g3kdf6){((function (_){return _.naturals_from=(function (x){return new _.infinite.y((function (n){return n+1}),x)}),_.naturals=_.naturals_from(0),_.n=(function (l,u,s){return (function (lower,upper){return (function (step){return new _.infinite.y((function (n){return n+step}),lower).take((function (x){return (upper-lower)*(upper-x)>0}))}).call(this,Math.abs(s||1)*(lower<upper?1: -1))}).call(this,arguments.length>1?l:0,arguments.length>1?u:l)}),_})).call(this,this.configure('seq.infinite.core seq.infinite.y seq.finite.core').seq)})})())).tconfiguration('std opt continuation','seq.dsl',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2hz8_g3kdfx=caterwaul.parse(' -x');
var gensym_2_gmjq2hz8_g3kdfy=caterwaul.parse('[_]');
var gensym_2_gmjq2hz8_g3kdfz=caterwaul.parse('_[_]');
var gensym_2_gmjq2hz8_g3kdg0=caterwaul.parse(' +_');
var gensym_2_gmjq2hz8_g3kdg1=caterwaul.parse('_+x');
var gensym_2_gmjq2hz8_g3kdg2=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2hz8_g3kdg3=caterwaul.parse('qg[fn[f][fn_[ !f.apply(this,arguments)]]]');
var gensym_2_gmjq2hz8_g3kdg4=caterwaul.parse('fn[xs][y]');
var gensym_2_gmjq2hz8_g3kdg5=caterwaul.parse('fb');
var gensym_2_gmjq2hz8_g3kdg6=caterwaul.parse('fn');
var gensym_2_gmjq2hz8_g3kdg7=caterwaul.parse('_x.filter(_y)');
var gensym_2_gmjq2hz8_g3kdg8=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdg9=caterwaul.parse('_x.map(_y)');
var gensym_2_gmjq2hz8_g3kdga=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgb=caterwaul.parse('_x.foldl(_y)');
var gensym_2_gmjq2hz8_g3kdgc=caterwaul.parse('_,_0,_i');
var gensym_2_gmjq2hz8_g3kdgd=caterwaul.parse('_x.filter(c(_y))');
var gensym_2_gmjq2hz8_g3kdge=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgf=caterwaul.parse('_x.each(_y)');
var gensym_2_gmjq2hz8_g3kdgg=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgh=caterwaul.parse('_x.foldr(_y)');
var gensym_2_gmjq2hz8_g3kdgi=caterwaul.parse('_,_0,_i');
var gensym_2_gmjq2hz8_g3kdgj=caterwaul.parse('_x.forall(_y)');
var gensym_2_gmjq2hz8_g3kdgk=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgl=caterwaul.parse('_x.exists(_y)');
var gensym_2_gmjq2hz8_g3kdgm=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgn=caterwaul.parse('_x.flat_map(_y)');
var gensym_2_gmjq2hz8_g3kdgo=caterwaul.parse('_,_i');
var gensym_2_gmjq2hz8_g3kdgp=caterwaul.parse('_x.drop(_y)');
var gensym_2_gmjq2hz8_g3kdgq=caterwaul.parse('_');
var gensym_2_gmjq2hz8_g3kdgr=caterwaul.parse('_x.take(_y)');
var gensym_2_gmjq2hz8_g3kdgs=caterwaul.parse('_');
var gensym_2_gmjq2hz8_g3kdgt=caterwaul.parse('new caterwaul.seq.infinite.y(_y,_x)');
var gensym_2_gmjq2hz8_g3kdgu=caterwaul.parse('_');
var gensym_2_gmjq2hz8_g3kdgv=caterwaul.parse('_+_');
var gensym_2_gmjq2hz8_g3kdgw=caterwaul.parse('qg[_x].size()+qg[_y].size()');
var gensym_2_gmjq2hz8_g3kdgx=caterwaul.parse('_&&_');
var gensym_2_gmjq2hz8_g3kdgy=caterwaul.parse('((function (xp){return xp&&xp.size()?_y:xp}).call(this,_x))');
var gensym_2_gmjq2hz8_g3kdgz=caterwaul.parse('_||_');
var gensym_2_gmjq2hz8_g3kdh0=caterwaul.parse('((function (xp){return xp&&xp.size()?xp:_y}).call(this,_x))');
var gensym_2_gmjq2hz8_g3kdh1=caterwaul.parse('_===_');
var gensym_2_gmjq2hz8_g3kdh2=caterwaul.parse('qg[l[xp=_x,yp=_y][xp===yp||xp.size()===yp.size()&&xp.zip(yp).forall(fn[p][p[0]===p[1]])]]');
var gensym_2_gmjq2hz8_g3kdh3=caterwaul.parse('_!==_');
var gensym_2_gmjq2hz8_g3kdh4=caterwaul.parse('qg[l[xp=_x,yp=_y][xp!==yp&&(xp.size()!==yp.size()||xp.zip(yp).exists(fn[p][p[0]!==p[1]]))]]');
var gensym_2_gmjq2hz8_g3kdh5=caterwaul.parse('_^_');
var gensym_2_gmjq2hz8_g3kdh6=caterwaul.parse('_x.zip(_y)');
var gensym_2_gmjq2hz8_g3kdh7=caterwaul.parse('_+_');
var gensym_2_gmjq2hz8_g3kdh8=caterwaul.parse('_x.concat(_y)');
var gensym_2_gmjq2hz8_g3kdh9=caterwaul.parse(' !_');
var gensym_2_gmjq2hz8_g3kdha=caterwaul.parse('_x.object()');
var gensym_2_gmjq2hz8_g3kdhb=caterwaul.parse('_,_');
var gensym_2_gmjq2hz8_g3kdhc=caterwaul.parse('_x,_y');
var gensym_2_gmjq2hz8_g3kdhd=caterwaul.parse(' ~_');
var gensym_2_gmjq2hz8_g3kdhe=caterwaul.parse('qg[new caterwaul.seq.finite(_x)]');
var gensym_2_gmjq2hz8_g3kdhf=caterwaul.parse('_?_:_');
var gensym_2_gmjq2hz8_g3kdhg=caterwaul.parse('x?y:z');
var gensym_2_gmjq2hz8_g3kdhh=caterwaul.parse('_(_)');
var gensym_2_gmjq2hz8_g3kdhi=caterwaul.parse('_x(_y)');
var gensym_2_gmjq2hz8_g3kdhj=caterwaul.parse('_[_]');
var gensym_2_gmjq2hz8_g3kdhk=caterwaul.parse('_x[_y]');
var gensym_2_gmjq2hz8_g3kdhl=caterwaul.parse('_._');
var gensym_2_gmjq2hz8_g3kdhm=caterwaul.parse('_x._y');
var gensym_2_gmjq2hz8_g3kdhn=caterwaul.parse('_');
var gensym_2_gmjq2hz8_g3kdho=caterwaul.parse('qg[_x]');
var gensym_2_gmjq2hz8_g3kdhp=caterwaul.parse(' +_');
var gensym_2_gmjq2hz8_g3kdhq=caterwaul.parse('N');
var gensym_2_gmjq2hz8_g3kdhr=caterwaul.parse('caterwaul.seq.naturals');
var gensym_2_gmjq2hz8_g3kdhs=caterwaul.parse('N[_]');
var gensym_2_gmjq2hz8_g3kdht=caterwaul.parse('caterwaul.seq.naturals_from(x)');
var gensym_2_gmjq2hz8_g3kdhu=caterwaul.parse('n[_]');
var gensym_2_gmjq2hz8_g3kdhv=caterwaul.parse('caterwaul.seq.n(x)');
var gensym_2_gmjq2hz8_g3kdhx=caterwaul.parse('p[_]');
var gensym_2_gmjq2hz8_g3kdhy=caterwaul.parse('caterwaul.seq.finite.r(x)');
var gensym_2_gmjq2hz8_g3kdhz=caterwaul.parse('seq[_]');
var gensym_2_gmjq2hz8_g3kdi0=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2hz8_g3kdf7){this.configure('seq.core seq.infinite.y seq.finite.core seq.finite.zip seq.finite.traversal seq.finite.mutability').seq.dsl=((function (_){return (function (){var rxy=(function (tree){return (function (x,y){return tree.replace({_x:_.macroexpand(x),_y:y&&_.macroexpand(y)})})}),seq=(function (gensym_2_gmjq2hz8_g3kdfw){return (function (){return (function (xs){return new this.seq.finite(xs)}).apply(gensym_2_gmjq2hz8_g3kdfw,arguments)})})(this),prepend=(function (operator){return (function (x){return ((function (_){return _.data=operator,_})).call(this,gensym_2_gmjq2hz8_g3kdfx.replace({x:x}))})}),tree_forms=(function (){var base=seq([gensym_2_gmjq2hz8_g3kdfy,gensym_2_gmjq2hz8_g3kdfz]),mod=(function (fs,op){return fs.concat(fs.map(prepend(op)))});
return mod(mod(base,'u-'),'u~').concat(seq([gensym_2_gmjq2hz8_g3kdg0]))}).call(this),template=(function (op){return (function (t){return ((function (_){return _.data=op,_})).call(this,gensym_2_gmjq2hz8_g3kdg1.replace({x:t}))})}),qw=gensym_2_gmjq2hz8_g3kdg2.util.qw,not=gensym_2_gmjq2hz8_g3kdg3,trees_for=(function (op){return ((function (_){return _.map(template(op.replace(/!$/,'')))})).call(this,((function (_){return op.charAt(op.length-1)==='!'?_.map(prepend('u!')):_})).call(this,tree_forms))});
return _.prefix_substitute=(function (tree,prefix){return tree.rmap((function (n){return (n.data.charAt(0)==='_')&&(new n.constructor((''+(prefix)+''+(n.data.substring(1))+'')))}))}),_.define_functional=(function (op,expansion,xs){return trees_for(op).map((function (t,i){return _.macro(t,(function (l,v,r){return expansion.replace({_x:_.macroexpand(l),_y:i>=8?v:gensym_2_gmjq2hz8_g3kdg4.replace({fn:i&2?gensym_2_gmjq2hz8_g3kdg5:gensym_2_gmjq2hz8_g3kdg6,xs:_.prefix_substitute(xs,i&1?v.data:'_'),y:(i&4?_.macroexpand:(function (x){return x}))(r||v)})})}))}))}),((function (_){return _('%',gensym_2_gmjq2hz8_g3kdg7,gensym_2_gmjq2hz8_g3kdg8),_('*',gensym_2_gmjq2hz8_g3kdg9,gensym_2_gmjq2hz8_g3kdga),_('/',gensym_2_gmjq2hz8_g3kdgb,gensym_2_gmjq2hz8_g3kdgc),_('%!',gensym_2_gmjq2hz8_g3kdgd.replace({c:not}),gensym_2_gmjq2hz8_g3kdge),_('*!',gensym_2_gmjq2hz8_g3kdgf,gensym_2_gmjq2hz8_g3kdgg),_('/!',gensym_2_gmjq2hz8_g3kdgh,gensym_2_gmjq2hz8_g3kdgi),_('&',gensym_2_gmjq2hz8_g3kdgj,gensym_2_gmjq2hz8_g3kdgk),_('|',gensym_2_gmjq2hz8_g3kdgl,gensym_2_gmjq2hz8_g3kdgm),_('-',gensym_2_gmjq2hz8_g3kdgn,gensym_2_gmjq2hz8_g3kdgo),_('>>',gensym_2_gmjq2hz8_g3kdgp,gensym_2_gmjq2hz8_g3kdgq),_('<<',gensym_2_gmjq2hz8_g3kdgr,gensym_2_gmjq2hz8_g3kdgs),_('>>>',gensym_2_gmjq2hz8_g3kdgt,gensym_2_gmjq2hz8_g3kdgu),_})).call(this,_.define_functional),seq(qw('> < >= <= == !=')).each((function (op){return _.macro(((function (_){return _.data=op,_})).call(this,gensym_2_gmjq2hz8_g3kdgv.clone()),rxy(((function (_){return _.data=op,_})).call(this,gensym_2_gmjq2hz8_g3kdgw.clone())))})),(function (e){return ((function (_){return _(gensym_2_gmjq2hz8_g3kdgx,rxy(gensym_2_gmjq2hz8_g3kdgy)),_(gensym_2_gmjq2hz8_g3kdgz,rxy(gensym_2_gmjq2hz8_g3kdh0)),_(gensym_2_gmjq2hz8_g3kdh1,rxy(gensym_2_gmjq2hz8_g3kdh2)),_(gensym_2_gmjq2hz8_g3kdh3,rxy(gensym_2_gmjq2hz8_g3kdh4)),_(gensym_2_gmjq2hz8_g3kdh5,rxy(gensym_2_gmjq2hz8_g3kdh6)),_(gensym_2_gmjq2hz8_g3kdh7,rxy(gensym_2_gmjq2hz8_g3kdh8)),_(gensym_2_gmjq2hz8_g3kdh9,rxy(gensym_2_gmjq2hz8_g3kdha)),_(gensym_2_gmjq2hz8_g3kdhb,rxy(gensym_2_gmjq2hz8_g3kdhc)),_(gensym_2_gmjq2hz8_g3kdhd,rxy(gensym_2_gmjq2hz8_g3kdhe)),_(gensym_2_gmjq2hz8_g3kdhf,(function (x,y,z){return gensym_2_gmjq2hz8_g3kdhg.replace({x:e(x),y:e(y),z:e(z)})})),(function (rx){return _(gensym_2_gmjq2hz8_g3kdhh,rx(gensym_2_gmjq2hz8_g3kdhi)),_(gensym_2_gmjq2hz8_g3kdhj,rx(gensym_2_gmjq2hz8_g3kdhk)),_(gensym_2_gmjq2hz8_g3kdhl,rx(gensym_2_gmjq2hz8_g3kdhm)),_(gensym_2_gmjq2hz8_g3kdhn.as('('),rx(gensym_2_gmjq2hz8_g3kdho))}).call(this,(function (t){return (function (x,y){return t.replace({_x:e(x),_y:y})})})),_(gensym_2_gmjq2hz8_g3kdhp,(function (x){return x})),(function (rx){return _(gensym_2_gmjq2hz8_g3kdhq,(function (){return gensym_2_gmjq2hz8_g3kdhr})),_(gensym_2_gmjq2hz8_g3kdhs,rx(gensym_2_gmjq2hz8_g3kdht)),_(gensym_2_gmjq2hz8_g3kdhu,rx(gensym_2_gmjq2hz8_g3kdhv))}).call(this,(function (t){return (function (x){return t.replace({x:x})})})),seq(qw('sk sv sp')).zip(qw('keys values pairs')).each((function (gensym_2_gmjq2hz8_g3kdhw){return (function (){return (function (p){return _(gensym_2_gmjq2hz8_g3kdhx.replace({p:p[0]}),(function (x){return gensym_2_gmjq2hz8_g3kdhy.replace({r:p[1],x:x})}))}).apply(gensym_2_gmjq2hz8_g3kdhw,arguments)})})(this)),_})).call(this,_.macro)}).call(this,(function (x){return _.macroexpand(x)})),this.rmacro(gensym_2_gmjq2hz8_g3kdhz,_.macroexpand)}).call(this),_})).call(this,gensym_2_gmjq2hz8_g3kdi0.global().clone())})})())).configuration('seq',function (gensym_2_gmjq2hz8_g3kdf8){this.configure('seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification '+'seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal '+'seq.numeric seq.dsl')});





caterwaul.tconfiguration('std seq','heap',caterwaul.precompiled_internal((function (){var gensym_2_gmjq28wb_7yi7qc=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq');
return (function (gensym_2_gmjq28wb_7yi7qa){this.heap=(function (less){return ((function (c){return c.prototype=((function (_){return _.insert=(function (x){return this.push(x).heapify_up(this.size()-1)}),_.root=(function (){return this[0]}),_.rroot=(function (){return ((function (_){return ((function (_){return (this.size())&&(this[0]=_,this.heapify_down(0)),_})).call(this,this.pop()),_})).call(this,this[0])}),_.swap=(function (i,j){return ((function (_){return (function (temp){return _[j]=_[i],_[i]=temp}).call(this,_[j]),_})).call(this,this)}),_.heapify_up=(function (i){return ((function (_){return (function (p){return (less.call(_,_[i],_[p]))&&(_.swap(i,p).heapify_up(p))}).call(this,i>>1),_})).call(this,this)}),_.heapify_down=(function (i){return ((function (_){return (function (){var s=_.size(),r=i+1<<1,l=r-1,ll=l<s&&less.call(_,_[l],_[i])?l:i,lr=r<s&&less.call(_,_[r],_[ll])?r:ll;
return  !(lr===i)&&(_.swap(lr,i).heapify_down(lr))}).call(this),_})).call(this,this)}),_})).call(this,((function (_){return _.constructor=c,_})).call(this,new gensym_2_gmjq28wb_7yi7qc.seq.finite())),c})).call(this,((function (vars){return null,undefined})))})})})()));





caterwaul.tconfiguration('std seq continuation','memoize',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2ceg_9dj03x=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2ceg_9dj03y=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2ceg_9dj03v){((function (m){return m.wrap=(function (f){return ((function (_){return _.original=f,_})).call(this,(function (){return (function (as,start){return ((function (_){return _.time= +new Date()-start,_})).call(this,gensym_2_gmjq2ceg_9dj03x.continuation.unwind_protect((function (gensym_2_gmjq2ceg_9dizyr){return (function (){return (function (e){return {error:e}}).apply(gensym_2_gmjq2ceg_9dizyr,arguments)})})(this),(function (gensym_2_gmjq2ceg_9dizys){return (function (){return (function (){return {result:f.apply(this,as)}}).apply(gensym_2_gmjq2ceg_9dizys,arguments)})})(this)))}).call(this,arguments, +new Date())}))}),m.perform=(function (result){return result.error?gensym_2_gmjq2ceg_9dj03y.continuation.unwind(result.error):result.result}),m.from=(function (proxy){return (function (f){return (function (state,g){return (function (){return m.perform(proxy.call(state,this,arguments,g))})}).call(this,{},m.wrap(f))})}),m})).call(this,this.namespace('memoize'))})})()));





caterwaul.tconfiguration('std seq continuation memoize','parser.core',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahrc=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation memoize');
var gensym_2_gmjq2fsh_b9ahrd=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation memoize');
return (function (gensym_2_gmjq2fsh_b9ahr1){((function (_){return _.parse_state=(function (input,i,result,memo){return ((function (_){return this.input=input,this.i=i,this.result=result,this.memo=memo,_})).call(this,undefined)}),((function (s){return s.from_input=(function (input){return new _.parse_state(input,0,null,{})}),((function (_){return _.accept=(function (i,r){return new this.constructor(this.input,i,r,this.memo)}),_.has_input=(function (){return this.i<this.input.length}),_.toString=(function (){return ('ps['+(this.input.substr(this.i))+', '+(this.result)+']')}),_})).call(this,s.prototype),s})).call(this,_.parse_state),_.memoize=gensym_2_gmjq2fsh_b9ahrc.memoize.from((function (c,as,f){return (function (k,m){return k in m?m[k]:(m[k]=f.apply(c,as))}).call(this,(''+(f.original.memo_id)+'|'+(as[0].i)+''),as[0].memo||(as[0].memo={}))})),_.promote_non_states=(function (f){return (function (state){return state instanceof _.parse_state?f.call(this,state):((function (_){return _&&_.result})).call(this,f.call(this,_.parse_state.from_input(state)))})}),_.identify=(function (f){return ((function (_){return _.memo_id=gensym_2_gmjq2fsh_b9ahrd.gensym(),_})).call(this,f)}),_.parser=(function (f){return _.promote_non_states(_.memoize(_.identify(f)))}),_.defparser=(function (name,f){return _.parsers[name]=(function (){return _.parser(f.apply(this,arguments))})}),_.parsers={},_})).call(this,this.namespace('parser'))})})())).tconfiguration('std seq continuation','parser.c',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahrf=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahrg=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahrh=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahri=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2fsh_b9ahr2){this.configure('parser.core').parser.defparser('c',(function (x,l){return (function (){var check_index=(function (i,s,p){return i.exists((function (_,_i){return (function (s){return _[('@'+(s)+'')]&&s}).call(this,s.substr(p,_.length))}))}),index_entries=(function (xs){return (function (){var xsp=(new gensym_2_gmjq2fsh_b9ahrf.seq.finite(xs)),ls=gensym_2_gmjq2fsh_b9ahrg.seq.finite.keys((xsp.map((function (_,_i){return [_.length,true]}))).object()).map((function (_,_i){return Number(_)}));
return (new gensym_2_gmjq2fsh_b9ahrh.seq.finite(ls.slice().sort((function (x,y){return y-x})))).map((function (l,li){return (xsp.filter((function (_,_i){return _.length===l})).map((function (_,_i){return [('@'+(_)+''),true]})).concat([['length',l]])).object()}))}).call(this)}),add_absolute_anchors_to=(function (x){return (function (parts){return new RegExp(('^'+(parts[1])+'$'),parts[2])}).call(this,/^\/(.*)\/(\w*)$/.exec(x.toString()))}),fail_length=(function (re,s,p,l){return re.test(s.substr(p,l))?p+(l<<1)<=s.length?fail_length(re,s,p,l<<1):l<<1:l}),split_lengths=(function (re,s,p,l,u){return (function (){var b=(function (l,u){return l+1<u?((function (m){return re.test(s.substr(p,m))?b(m,u):b(l,m)})).call(this,(l+(u-l>>1))):l});
return b(l,u)}).call(this)});
return x.constructor===String?(function (st){return (x===st.input.substr(st.i,x.length))&&(st.accept(st.i+x.length,x))}):x instanceof Array?(function (index){return (function (st){return ((function (_){return _&&st.accept(st.i+_.length,_)})).call(this,check_index(index,st.input,st.i))})}).call(this,index_entries(x)):x.constructor===RegExp?(function (x){return (function (st){return ((function (_){return _>l&&((function (_){return st.accept(st.i+_,x.exec(st.input.substr(st.i,_)))})).call(this,split_lengths(x,st.input,st.i,l,_))})).call(this,fail_length(x,st.input,st.i,l))})}).call(this,add_absolute_anchors_to(x)):x.constructor===Function?(function (st){return ((function (_){return _&&st.accept(st.i+_,st.input.substr(st.i,_))})).call(this,x.call(st,st.input,st.i))}):(function (index){return (function (st){return ((function (_){return _&&st.accept(st.i+_.length,x[_])})).call(this,check_index(index,st.input,st.i))})}).call(this,index_entries(gensym_2_gmjq2fsh_b9ahri.seq.finite.keys(x)))}).call(this)}))})})())).tconfiguration('std opt seq continuation','parser.seq',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahrk=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2fsh_b9ahr3){this.configure('parser.core').parser.defparser('seq',(function (){return (function (as){return (function (state){return (function (result){return (gensym_2_gmjq2fsh_b9ahrk.continuation.call_cc.call(this,(function (cc){return (function (gensym_2_gmjq2fsh_b9ahlq){for (var gensym_2_gmjq2fsh_b9ahlr=gensym_2_gmjq2fsh_b9ahlq>=0&&gensym_2_gmjq2fsh_b9ahlq>>3,gensym_2_gmjq2fsh_b9ahls=gensym_2_gmjq2fsh_b9ahlq>=0&&gensym_2_gmjq2fsh_b9ahlq&7,i=0;
i<gensym_2_gmjq2fsh_b9ahls;
 ++i)(state=as[i](state))?result.push(state.result):cc(false);
for (var gensym_2_gmjq2fsh_b9ahlt=0;
gensym_2_gmjq2fsh_b9ahlt<gensym_2_gmjq2fsh_b9ahlr;
 ++gensym_2_gmjq2fsh_b9ahlt){(state=as[i](state))?result.push(state.result):cc(false);
i++;
...
(state=as[i](state))?result.push(state.result):cc(false);
i++};
return gensym_2_gmjq2fsh_b9ahlq}).call(this,as.length),state.accept(state.i,result)})))}).call(this,[])})}).call(this,arguments)}))})})())).tconfiguration('std opt seq continuation','parser.alt',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahrm=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2fsh_b9ahr4){this.configure('parser.core').parser.defparser('alt',(function (){return (function (as){return (function (state){return as.exists((function (_,_i){return _(state)}))})}).call(this,(new gensym_2_gmjq2fsh_b9ahrm.seq.finite(arguments)))}))})})())).tconfiguration('std opt seq continuation','parser.times',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahro=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahrp=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahrq=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2fsh_b9ahr5){this.configure('parser.core').parser.defparser('times',(function (p,lower,upper){return (function (state){return (function (count,result){return (gensym_2_gmjq2fsh_b9ahro.continuation.call_cc.call(this,(function (cc){return (function (gensym_2_gmjq2fsh_b9ahlq){for (var gensym_2_gmjq2fsh_b9ahlr=gensym_2_gmjq2fsh_b9ahlq>=0&&gensym_2_gmjq2fsh_b9ahlq>>3,gensym_2_gmjq2fsh_b9ahls=gensym_2_gmjq2fsh_b9ahlq>=0&&gensym_2_gmjq2fsh_b9ahlq&7,i=0;
i<gensym_2_gmjq2fsh_b9ahls;
 ++i) ++count,(state=p(state))?result.push(state.result):cc(false);
for (var gensym_2_gmjq2fsh_b9ahlt=0;
gensym_2_gmjq2fsh_b9ahlt<gensym_2_gmjq2fsh_b9ahlr;
 ++gensym_2_gmjq2fsh_b9ahlt){ ++count,(state=p(state))?result.push(state.result):cc(false);
i++;
...
i++;
 ++count,(state=p(state))?result.push(state.result):cc(false);
i++};
return gensym_2_gmjq2fsh_b9ahlq}).call(this,lower),true})))&&(gensym_2_gmjq2fsh_b9ahrp.continuation.call_cc.call(this,(function (){var loop=(function (cc){return ( !upper||count++<upper)&&state.has_input()&&((function (_){return (_)&&(state=_),_})).call(this,p(state))?result.push(state.result)&&(gensym_2_gmjq2fsh_b9ahrq.continuation.call_tail.call(loop,cc)):cc(state.accept(state.i,result))});
...
return (function (gensym_2_gmjq2fsh_b9ahr6){this.configure('parser.core').parser.defparser('opt',(function (p){return (function (state){return (function (){var s=p(state),n=s?s.i:state.i,r=s&&s.result;
...
return (function (gensym_2_gmjq2fsh_b9ahr7){((function (_){return _.defparser('match',(function (p){return (function (state){return ((function (_){return _&&state.accept(state.i,state.result)})).call(this,p(state))})})),_.defparser('reject',(function (p){return (function (state){return ((function (_){return  !_&&state.accept(state.i,null)})).call(this,p(state))})})),_})).call(this,this.configure('parser.core').parser)})})())).tconfiguration('std opt seq continuation','parser.bind',caterwaul.precompiled_internal((function (){null;
return (function (gensym_2_gmjq2fsh_b9ahr8){((function (_){return _.defparser('bind',(function (p,f){return (function (state){return ((function (_){return _&&_.accept(_.i,f.call(_,_.result))})).call(this,p(state))})})),_})).call(this,this.configure('parser.core').parser)})})())).tconfiguration('std opt seq continuation','parser.dsl',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2fsh_b9ahrv=caterwaul.parse('peg[_]');
var gensym_2_gmjq2fsh_b9ahrw=caterwaul.parse('qg[l*[_bindings][_parser]]');
var gensym_2_gmjq2fsh_b9ahrx=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
var gensym_2_gmjq2fsh_b9ahry=caterwaul.parse('_x=_y');
var gensym_2_gmjq2fsh_b9ahrz=caterwaul.parse('_name(_x,_y)');
var gensym_2_gmjq2fsh_b9ahs0=caterwaul.parse('_name(_x,_y)');
var gensym_2_gmjq2fsh_b9ahs1=caterwaul.parse('_name(_x)');
var gensym_2_gmjq2fsh_b9ahs2=caterwaul.parse('_(_)');
var gensym_2_gmjq2fsh_b9ahs3=caterwaul.parse('_x(_y)');
var gensym_2_gmjq2fsh_b9ahs4=caterwaul.parse('_/_');
var gensym_2_gmjq2fsh_b9ahs5=caterwaul.parse('_%_');
var gensym_2_gmjq2fsh_b9ahs6=caterwaul.parse('_>>_');
var gensym_2_gmjq2fsh_b9ahs7=caterwaul.parse('[_]');
var gensym_2_gmjq2fsh_b9ahs8=caterwaul.parse('_');
var gensym_2_gmjq2fsh_b9ahs9=caterwaul.parse('_[_]');
var gensym_2_gmjq2fsh_b9ahsa=caterwaul.parse('times(_x,_l)');
var gensym_2_gmjq2fsh_b9ahsb=caterwaul.parse('_[_,_]');
var gensym_2_gmjq2fsh_b9ahsc=caterwaul.parse('times(_x,_l,_u)');
var gensym_2_gmjq2fsh_b9ahsd=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std opt.unroll opt seq.core seq.finite.core seq.finite.object seq.finite.mutability seq.finite.traversal seq.finite.zip seq.finite.quantification seq.finite.serialization seq.infinite.core seq.infinite.y seq.infinite.transform seq.infinite.traversal seq.numeric seq.dsl seq continuation.core continuation.unwind continuation.cps continuation.delimited continuation');
return (function (gensym_2_gmjq2fsh_b9ahr9){this.configure('parser.core').rmacro(gensym_2_gmjq2fsh_b9ahrv,(function (x){return (function (outer){return gensym_2_gmjq2fsh_b9ahrw.replace({_bindings:new this.syntax(',',gensym_2_gmjq2fsh_b9ahrx.seq.finite.pairs(this.parser.parsers).map((function (_,_i){return gensym_2_gmjq2fsh_b9ahry.replace({_x:_[0],_y:new outer.ref(_[1])})}))),_parser:this.parser.dsl.macroexpand(x)})}).call(this,this)})),this.parser.dsl=((function (dsl){return ((function (_){return (function (){var e=dsl.macroexpand,fb=(function (op,name){return (function (x,y){return gensym_2_gmjq2fsh_b9ahrz.replace({_name:name,_x:((function (_){return _.data=',',_})).call(this,x.flatten(op).map(e)),_y:e(y)})})}),b=(function (name){return (function (x,y){return gensym_2_gmjq2fsh_b9ahs0.replace({_name:name,_x:e(x),_y:y})})}),u=(function (name){return (function (x){return gensym_2_gmjq2fsh_b9ahs1.replace({_name:name,_x:e(x)})})});
return _(gensym_2_gmjq2fsh_b9ahs2,(function (x,y){return gensym_2_gmjq2fsh_b9ahs3.replace({_x:e(x),_y:y})})),_(gensym_2_gmjq2fsh_b9ahs4,fb('/','alt')),_(gensym_2_gmjq2fsh_b9ahs5,fb('%','seq')),_(gensym_2_gmjq2fsh_b9ahs6,b('bind')),_(gensym_2_gmjq2fsh_b9ahs7,u('opt')),_(gensym_2_gmjq2fsh_b9ahs8.as('('),(function (x){return e(x).as('(')})),_(gensym_2_gmjq2fsh_b9ahs9,(function (x,l){return gensym_2_gmjq2fsh_b9ahsa.replace({_x:e(x),_l:l})})),_(gensym_2_gmjq2fsh_b9ahsb,(function (x,l,u){return gensym_2_gmjq2fsh_b9ahsc.replace({_x:e(x),_l:l,_u:u})}))}).call(this),_})).call(this,dsl.macro),dsl})).call(this,gensym_2_gmjq2fsh_b9ahsd.global().clone())})})())).configuration('parser',function (gensym_2_gmjq2fsh_b9ahra){this.configure('parser.core parser.c parser.seq parser.alt parser.times parser.opt parser.match parser.bind parser.dsl')});
