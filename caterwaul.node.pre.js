...
//   The function you give it will be invoked for each new adverb or adverb form. This function is also bound as a method called 'define_adverb'.
  ...
  caterwaul_global.method('macro_form', function (name, define) {
    ...
    return this.
      ...
      shallow(forms, []).
       method(form, function (form)             {for (var i = 0, xs = this[names], l = xs.length, d = this[define_name]; i < l; ++i) d.call(this, xs[i].name, xs[i].description, form);
