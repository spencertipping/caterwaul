...
caterwaul.tconfiguration('std','format',caterwaul.precompiled_internal((function (){var gensym_2_gmjq2789_25w7zy=caterwaul.clone('std.qs std.qg std.bind std.lvalue std.cond std.fn std.obj std.ref std.string std');
return (function (gensym_2_gmjq2789_25w7zv){var n_spaces=(function (n){return n?(' '+(n_spaces(n-1))+''):''});
this.field('format',function (tree,indentation,gensym_2_gmjq2789_25w7zw){var spaces=n_spaces(indentation<<1),c=this,op=tree.data,map=gensym_2_gmjq2789_25w7zy.util.map,serialize=(function (n){return (function (x){return x?x.constructor===String?x:c.format(x,(indentation||0)+(n||0)):''})});
