...
caterwaul.tconfiguration('std', 'error', function () {
  this.rmacro(qs[error.safely[_][_]], fn[expression, handler][qs[qg[function () {try {return _} catch (error) {return _}}]()].s('_', [expression, handler])]).
       rmacro(qs[error.quietly[_]],   fn[expression]         [qs[qg[function () {try {return _} catch (error) {return false}}]()].s('_', expression)]).
       rmacro(qs[error.fail[_]],      fn[expression]         [qs[qg[function () {throw _}]()].s('_', expression)])});
