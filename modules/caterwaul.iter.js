...
caterwaul.tconfiguration('std', 'iter', function () {
  this.rmacro(qs[iter.until[_][_]],   fn[condition, body]       [qs[qg[function () {while (! qg[_condition]) {_body}}].call(this)].replace({_condition: condition, _body: body})]).
       rmacro(qs[iter.keys[_, _][_]], fn[variable, object, body][with_gensyms[object][qg[function (object) {for (var _variable in object) {_body}}].call(this, _object)].
                                                                  replace({_variable: variable, _body: body, _object: object})]).
       rmacro(qs[iter.n[_, _][_]],    fn[variable, limit, body] [with_gensyms[limit][qg[function (limit) {for (var _i = 0; _i < limit; ++_i) {_body}}].call(this, _limit)].
