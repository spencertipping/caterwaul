...
\end{verbatim}
  ...
  That could be the end of the chapter, but if I stopped here then you wouldn't see the awesomeness that is Caterwaul's jQuery library. This app, rather than just sorting data, illustrates the
  process by recording each step of the quicksort as it happens.
