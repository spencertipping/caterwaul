...
caterwaul.module( 'regexp-grammar-compiler' , (function(qse,qs,qs1,qse1,qse2,qse3,qse4,qse5,qse6,qse7,qse8) {var result= (function($) {$.regexp_grammar=function(rules) {;
return(function() {var metaclass_constructor=function(name,args) {;
...
return(auxiliary_classes[sub] =metaclass(sub,piece) , (qse6) .replace( {_name:sub} ) ) } ) .call(this) } ,pieces=unflatten(tree) ,formals= ( [ 'start_' , 'end_' , 'length_' ] ) .concat( ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( ( '_' + (x) + '' ) ) ) ;
return xr} ) .call(this,pieces) ) ) ,parse_invocation=function(piece) {;
return auxiliary(piece._value||piece) } ;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0= (metaclass() ) ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= (new $.syntax( ';' ,x0,x) ) ;
