...
caterwaul.module( 'regexp-grammar-compiler' , (function(qse,qs,qs1,qse1,qse2,qse3,qse4,qse5,qse6,qs2,qs3,qs4,qse7,qse8,qse9,qs5,qsea,qseb,qs6,qs7,qs8,qs9,qsec,qsed,qsa) {var result= (function($) {$.regexp_grammar=function(rules) {;
return(function() {var metaclass=function(name,tree) {;
return tree.is_join() ?sequence_metaclass(name,tree) 
:tree.is_disjunction() ?alternative_metaclass(name,tree) 
:tree.is_forgetful() ? (function() {var sub=$.gensym(name) ;
return erased_variant_metaclass(name, (metaclass(sub,tree[0] ) ,sub) ) } ) .call(this) 
...
:invariant_metaclass(name,tree.toString() ) } ,metaclass_constructor=function(name,args) {;
return(function() {var template=qse,fold_into_comma=function(xs) {;
return(function(it) {return it.unflatten() } ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
...
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( /^_\d+/ .test(x) ? (qs) .replace( {_i:x.substr(1) ,_x:x} ) 
: (qs1) .replace( {_x:x} ) ) ) ;
return xr} ) .call(this,args) ) ;
return(template) .replace( {_name:name,_formals:formals,_formal_assignments:formal_assignments} ) } ) .call(this) } ,metaclass_instance=function(n,ctor,proto) {;
return(qse1) .replace( {_constructor:ctor,_prototype:proto,_name:n} ) } ,invariant_metaclass=function(name,k) {;
return(function() {var proto=function(k) {;
return(qse2) .replace( {_s:$.syntax.from_string(k) ,_l: ( '' + (k.length) + '' ) } ) } ,parser=function(name,k) {;
return(qse3) .replace( {_name:name,_s:$.syntax.from_string(k) ,_l: ( '' + (k.length) + '' ) } ) } ;
return metaclass_instance(name, (metaclass_constructor(name, [ 'start_' ] ) ) .replace( { '_@parser_implementation' :parser(name,k) } ) ,proto(k) ) } ) .call(this) } ,erased_variant_metaclass=function(name,sub) {;
return(function() {var parser=function(name,sub) {;
return(qse4) .replace( {_name:name,_parse:parse} ) } ;
return metaclass_instance(name, (metaclass_constructor(name, [ 'parsed_' ] ) ) .replace( { '_@parser_implementation' :parser(name,p) } ) ,qse5) } ) .call(this) } ,sequence_special_forms= (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ($.regexp(x, {atom: 'word' } ) ) ) ;
return xr} ) .call(this, [ /_ref@/ , /_ref@_rest/ , /_name:_value/ , /_name:_value _rest/ ] ) ,sequence_metaclass=function(name,tree) {;
return(function() {var metaclass=function() {;
return metaclass_instance(name, (metaclass_constructor(name,formals) ) .replace( { '_@parser_implementation' :parser} ) ,proto) } ,special_form=function(t) {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x1;
xi<xl;
 ++xi) {x=xs[xi] ;
...
return(function() {var sub=$.gensym(name) ;
return(auxiliary_classes[sub] =metaclass(sub,piece) , (qse6) .replace( {_name:sub} ) ) } ) .call(this) } ,pieces=unflatten(tree) ,formals= ( [ 'start_' , 'end_' ] ) .concat( ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( ( '_' + (x) + '' ) ) ) ;
return xr} ) .call(this,pieces) ) ) ,parse_invocation=function(piece) {;
return auxiliary(piece._value||piece) } ,parser= (function() {var steps=function(ps) {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0= (qs2) ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= ( ( '_x; _y' ) .replace( {_x:x0,_y:step_for(x,xi) } ) ) ;
return x0} ) .call(this,ps) } ,step_template=qs3,step_for=function(piece,i) {;
return(step_template) .replace( {_name: ( '_' + (i) + '' ) ,_invocation: (qs4) .replace( {_f:parse_invocation(piece) } ) } ) } ,instantiation= (qse7) .replace( {_name:name,_end: ( '_' + (pieces.length-1) + '' ) ,_formals: (function(xs) {var x,x0,xi,xl,xr;
for(var x0=xs[0] ,xi=1,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= ( ( '_x, _y' ) .replace( {_x:x0,_y:x} ) ) ;
return x0} ) .call(this,formals.slice(2) ) } ) ;
return(qse8) .replace( {_steps:steps(pieces) ,_instantiation:instantiation} ) } ) .call(this) ,proto= (function() {var map_qs=function() {;
return(qse9) .replace( {_stages:map_stages(pieces) } ) } ,map_stages=function(ps) {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0=xs[0] ,xi=1,xl=xs.length;
xi<xl;
...
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (map_stage(xi) ) ) ;
return xr} ) .call(this,ps) ) } ,map_stage=function(i) {;
return(qsea) .replace( {_i: ( '' + (i) + '' ) } ) } ,tostring_qs=function() {;
return(qseb) .replace( {_pieces:tostring_stages(pieces) } ) } ,tostring_stages=function(ps) {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0=xs[0] ,xi=1,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= ( (qs6) .replace( {_x:x0,_y:x} ) ) ;
return x0} ) .call(this, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( (qs7) .replace( {_i: ( '' + (xi) + '' ) } ) ) ) ;
return xr} ) .call(this,pieces) ) } ,intrinsics=$.syntax.from_object( {map:map_qs() ,toString:tostring_qs() } ) ,nominal_bindings= (function(o) {for(var r= {} ,i=0,l=o.length,x;
i<l;
 ++i)x=o[i] ,r[x[0] ] =x[1] ;
return r} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length,y;
xi<xl;
 ++xi)x=xs[xi] , (y= (x._name&& [x._name, (qs8) .replace( {_i:xi} ) ] ) ) &&xr.push(y) ;
return xr} ) .call(this,pieces) ) ) ;
return $.syntax.from_object($.merge( {} ,nominal_bindings,intrinsics) ) } ) .call(this) ;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0= (metaclass() ) ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= ( (qs9) .replace( {_x:x0,_y:x} ) ) ;
...
return tree.data=== '|' ? ( [tree[0] ] ) .concat(unflatten(tree[1] ) ) 
: [tree] } ,alternatives=unflatten(tree) ,alternative_names= (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ($.gensym( ( '' + (name) + '_alternative' ) ) ) ) ;
return xr} ) .call(this,alternatives) ,alternative_instances=$.regexp_grammar( (function(o) {for(var r= {} ,i=0,l=o.length,x;
i<l;
 ++i)x=o[i] ,r[x[0] ] =x[1] ;
return r} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( [alternative_names[xi] , ( '/' + (x) + '/' ) ] ) ) ;
return xr} ) .call(this,alternatives) ) ) ) ,parser= (qsec) .replace( {_names:$.syntax.from_array(alternative_names) } ) ;
return(qsed) .replace( {_name:name,_parser:parser,_alternatives:alternative_instances} ) } ) .call(this) } ;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0=xs[0] ,xi=1,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= ( (qsa) .replace( {_x:x0,_y:x} ) ) ;
return x0} ) .call(this, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (metaclass(x[0] ,x[1] ) ) ) ;
return xr} ) .call(this, (function(o) {var ps= [] ;
for(var k in o)Object.prototype.hasOwnProperty.call(o,k) &&ps.push( [k,o[k] ] ) ;
return ps} ) .call(this, ( (function(xs1) {var x2,x01,xi1,xl1,xr1;
var xr1=new xs1.constructor() ;
for(var k1 in xs1)if(Object.prototype.hasOwnProperty.call(xs1,k1) )x2=xs1[k1] ,xr1[k1] = ($.regexp(x2) ) ;
return xr1} ) .call(this,rules) ) ) ) ) } ) .call(this) } } ) ;
result.caterwaul_expression_ref_table= {qse: ( "new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"_formals\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"\" ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"?\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"constructor\" ) ) ,new caterwaul.syntax( \"_name\" ) ) ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"_formal_assignments\" ) ,new caterwaul.syntax( \"this\" ) ) ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"parse\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"arguments\" ) ,new caterwaul.syntax( \"0\" ) ) ,new caterwaul.syntax( \"||\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"arguments\" ) ,new caterwaul.syntax( \"1\" ) ) ,new caterwaul.syntax( \"0\" ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"parse\" ) ) ,new caterwaul.syntax( \"_@parser_implementation\" ) ) )" ) ,qs: ( "new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_i\" ) ) ,new caterwaul.syntax( \"_x\" ) )" ) ,qs1: ( "new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_x\" ) ) ,new caterwaul.syntax( \"_x\" ) )" ) ,qse1: ( "new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"_constructor\" ) ,new caterwaul.syntax( \"_prototype\" ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"prototype\" ) ) ,new caterwaul.syntax( \"constructor\" ) ) ,new caterwaul.syntax( \"_name\" ) ) )" ) ,qse2: ( "new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"map\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"f\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"r\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"f\" ) ,new caterwaul.syntax( \"this\" ) ) ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"?\" ,new caterwaul.syntax( \"||\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \"r\" ) ,new caterwaul.syntax( \"true\" ) ) ,new caterwaul.syntax( \"u!\" ,new caterwaul.syntax( \"r\" ) ) ) ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"r\" ) ) ) ) ) ) ) ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"end\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"\" ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"+\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"start_\" ) ) ,new caterwaul.syntax( \"_l\" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"length\" ) ,new caterwaul.syntax( \"0\" ) ) ) ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"toString\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"\" ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"_s\" ) ) ) ) ) ) ) )" ) ,qse3: ( "new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"&&\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \"_s\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"substr\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"i\" ) ,new caterwaul.syntax( \"_l\" ) ) ) ) ,new caterwaul.syntax( \"new\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"i\" ) ) ) ) ) ) ) )" ) ,qse4: ( "new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"result\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_sub\" ) ,new caterwaul.syntax( \"parse\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"&&\" ,new caterwaul.syntax( \"result\" ) ,new caterwaul.syntax( \"new\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"i\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"result\" ) ,new caterwaul.syntax( \"toString\" ) ) ,new caterwaul.syntax( \"\" ) ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( \"call\" ) ) ,new caterwaul.syntax( \"this\" ) ) ) ) ) )" ) ,qse5: ( "new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"map\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"f\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"r\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"f\" ) ,new caterwaul.syntax( \"this\" ) ) ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"?\" ,new caterwaul.syntax( \"||\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \"r\" ) ,new caterwaul.syntax( \"true\" ) ) ,new caterwaul.syntax( \"u!\" ,new caterwaul.syntax( \"r\" ) ) ) ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"r\" ) ) ) ) ) ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"end\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"\" ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"+\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"start_\" ) ) ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"parsed_\" ) ) ,new caterwaul.syntax( \"length\" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"length\" ) ,new caterwaul.syntax( \"0\" ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"toString\" ) ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"\" ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"parsed_\" ) ) ) ) ) ) ) ) ) ) )" ) ,qse6: ( "new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"ii\" ) ) )" ) ,qs2: ( "new caterwaul.syntax( \"null\" )" ) ,qs3: ( "new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"_invocation\" ) ) ) ,new caterwaul.syntax( \"if\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"u!\" ,new caterwaul.syntax( \"_name\" ) ) ) ,new caterwaul.syntax( \"return\" ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"ii\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"end\" ) ) ,new caterwaul.syntax( \"\" ) ) ) )" ) ,qs4: ( "new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"_f\" ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"ii\" ) ) )" ) ,qse7: ( "new caterwaul.syntax( \"new\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"i\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"_end\" ) ,new caterwaul.syntax( \"end\" ) ) ,new caterwaul.syntax( \"\" ) ) ) ,new caterwaul.syntax( \"_formals\" ) ) ) )" ) ,qse8: ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"ii\" ) ,new caterwaul.syntax( \"i\" ) ) ) ,new caterwaul.syntax( \"_steps\" ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"_instantiation\" ) ) ) ) )" ) ,qse9: ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"f\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"||\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \"f\" ) ,new caterwaul.syntax( \"this\" ) ) ,new caterwaul.syntax( \"this\" ) ) ) ) ,new caterwaul.syntax( \"if\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"true\" ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"this\" ) ) ) ) ,new caterwaul.syntax( \"_stages\" ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"receiver\" ) ) ) ) )" ) ,qs5: ( "new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"_x\" ) ,new caterwaul.syntax( \"_y\" ) )" ) ,qsea: ( "new caterwaul.syntax( \"i;\" ,new caterwaul.syntax( \"if\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"&&\" ,new caterwaul.syntax( \"===\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"this\" ) ) ,new caterwaul.syntax( \"!==\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"x\" ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_i\" ) ) ,new caterwaul.syntax( \"map\" ) ) ,new caterwaul.syntax( \"f\" ) ) ) ) ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"_i\" ) ) ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"new\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"constructor\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"start\" ) ) ,new caterwaul.syntax( \"\" ) ) ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"end\" ) ) ,new caterwaul.syntax( \"\" ) ) ) ) ) ) ,new caterwaul.syntax( \"for\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"j\" ) ,new caterwaul.syntax( \"0\" ) ) ) ,new caterwaul.syntax( \"<\" ,new caterwaul.syntax( \"j\" ) ,new caterwaul.syntax( \"_i\" ) ) ) ,new caterwaul.syntax( \"u++\" ,new caterwaul.syntax( \"j\" ) ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"j\" ) ) ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"j\" ) ) ) ) ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"receiver\" ) ,new caterwaul.syntax( \"_i\" ) ) ,new caterwaul.syntax( \"x\" ) ) )" ) ,qseb: ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"[\" ,new caterwaul.syntax( \"_pieces\" ) ) ,new caterwaul.syntax( \"join\" ) ) ,new caterwaul.syntax( \"''\" ) ) ) ) )" ) ,qs6: ( "new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"_x\" ) ,new caterwaul.syntax( \"_y\" ) )" ) ,qs7: ( "new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_i\" ) ) ,new caterwaul.syntax( \"toString\" ) ) ,new caterwaul.syntax( \"\" ) )" ) ,qs8: ( "new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_i\" ) ) ) ) )" ) ,qs9: ( "new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"_x\" ) ,new caterwaul.syntax( \"_y\" ) )" ) ,qsec: ( "new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"function\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"xs\" ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"x\" ) ,new caterwaul.syntax( \"x0\" ) ) ,new caterwaul.syntax( \"xi\" ) ) ,new caterwaul.syntax( \"xl\" ) ) ,new caterwaul.syntax( \"xr\" ) ) ) ,new caterwaul.syntax( \"i;\" ,new caterwaul.syntax( \"for\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"var\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"x\" ) ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"xs\" ) ,new caterwaul.syntax( \"0\" ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"xi\" ) ,new caterwaul.syntax( \"0\" ) ) ) ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"xl\" ) ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"xs\" ) ,new caterwaul.syntax( \"length\" ) ) ) ) ,new caterwaul.syntax( \"x_k_lq6ve5OyE4yDT_oYRjxWW1\" ) ) ) ,new caterwaul.syntax( \"<\" ,new caterwaul.syntax( \"xi\" ) ,new caterwaul.syntax( \"xl\" ) ) ) ,new caterwaul.syntax( \"u++\" ,new caterwaul.syntax( \"xi\" ) ) ) ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"x\" ) ,new caterwaul.syntax( \"[]\" ,new caterwaul.syntax( \"xs\" ) ,new caterwaul.syntax( \"xi\" ) ) ) ,new caterwaul.syntax( \"if\" ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"x_k_lq6ve5OyE4yDT_oYRjxWW1\" ) ,new caterwaul.syntax( \"(\" ,new caterwaul.syntax( \"()\" ,new caterwaul.syntax( \".\" ,new caterwaul.syntax( \"x\" ) ,new caterwaul.syntax( \"parse\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"s\" ) ,new caterwaul.syntax( \"i\" ) ) ) ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"x_k_lq6ve5OyE4yDT_oYRjxWW1\" ) ) ) ) ) ) ,new caterwaul.syntax( \"return\" ,new caterwaul.syntax( \"false\" ) ) ) ) ) ) ) ,new caterwaul.syntax( \"call\" ) ) ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"this\" ) ,new caterwaul.syntax( \"_names\" ) ) ) ) ) ) )" ) ,qsed: ( "new caterwaul.syntax( \",\" ,new caterwaul.syntax( \"=\" ,new caterwaul.syntax( \"_name\" ) ,new caterwaul.syntax( \"{\" ,new caterwaul.syntax( \",\" ,new caterwaul.syntax( \":\" ,new caterwaul.syntax( \"parse\" ) ,new caterwaul.syntax( \"_parser\" ) ) ) ) ) ,new caterwaul.syntax( \"_alternatives\" ) )" ) ,qsa: ( "new caterwaul.syntax( \";\" ,new caterwaul.syntax( \"_x\" ) ,new caterwaul.syntax( \"_y\" ) )" ) } ;
return(result) } ) .call(this,new caterwaul.syntax( "," ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_formals" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "constructor" ) ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_formal_assignments" ) ,new caterwaul.syntax( "this" ) ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "parse" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "arguments" ) ,new caterwaul.syntax( "0" ) ) ,new caterwaul.syntax( "||" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "arguments" ) ,new caterwaul.syntax( "1" ) ) ,new caterwaul.syntax( "0" ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "parse" ) ) ,new caterwaul.syntax( "_@parser_implementation" ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_i" ) ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_constructor" ) ,new caterwaul.syntax( "_prototype" ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "prototype" ) ) ,new caterwaul.syntax( "constructor" ) ) ,new caterwaul.syntax( "_name" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "map" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "f" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "r" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "this" ) ) ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "||" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "r" ) ,new caterwaul.syntax( "true" ) ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "r" ) ) ) ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "r" ) ) ) ) ) ) ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "end" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "+" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "start_" ) ) ,new caterwaul.syntax( "_l" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "length" ) ,new caterwaul.syntax( "0" ) ) ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "toString" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_s" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "_s" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "substr" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "i" ) ,new caterwaul.syntax( "_l" ) ) ) ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "i" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "result" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_sub" ) ,new caterwaul.syntax( "parse" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "result" ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "i" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "result" ) ,new caterwaul.syntax( "toString" ) ) ,new caterwaul.syntax( "" ) ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "this" ) ) ) ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "," ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "map" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "f" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "r" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "this" ) ) ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "||" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "r" ) ,new caterwaul.syntax( "true" ) ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "r" ) ) ) ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "r" ) ) ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "end" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "+" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "start_" ) ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "parsed_" ) ) ,new caterwaul.syntax( "length" ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "length" ) ,new caterwaul.syntax( "0" ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "toString" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "parsed_" ) ) ) ) ) ) ) ) ) ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "ii" ) ) ) ,new caterwaul.syntax( "null" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_invocation" ) ) ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "_name" ) ) ) ,new caterwaul.syntax( "return" ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "ii" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "end" ) ) ,new caterwaul.syntax( "" ) ) ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "ii" ) ) ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "i" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_end" ) ,new caterwaul.syntax( "end" ) ) ,new caterwaul.syntax( "" ) ) ) ,new caterwaul.syntax( "_formals" ) ) ) ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "ii" ) ,new caterwaul.syntax( "i" ) ) ) ,new caterwaul.syntax( "_steps" ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_instantiation" ) ) ) ) ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "f" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "||" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "f" ) ,new caterwaul.syntax( "this" ) ) ,new caterwaul.syntax( "this" ) ) ) ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "true" ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "this" ) ) ) ) ,new caterwaul.syntax( "_stages" ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "receiver" ) ) ) ) ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "this" ) ) ,new caterwaul.syntax( "!==" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "x" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_i" ) ) ,new caterwaul.syntax( "map" ) ) ,new caterwaul.syntax( "f" ) ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "_i" ) ) ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "constructor" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "start" ) ) ,new caterwaul.syntax( "" ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "end" ) ) ,new caterwaul.syntax( "" ) ) ) ) ) ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "j" ) ,new caterwaul.syntax( "0" ) ) ) ,new caterwaul.syntax( "<" ,new caterwaul.syntax( "j" ) ,new caterwaul.syntax( "_i" ) ) ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "j" ) ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "j" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "j" ) ) ) ) ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "receiver" ) ,new caterwaul.syntax( "_i" ) ) ,new caterwaul.syntax( "x" ) ) ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_pieces" ) ) ,new caterwaul.syntax( "join" ) ) ,new caterwaul.syntax( "''" ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_i" ) ) ,new caterwaul.syntax( "toString" ) ) ,new caterwaul.syntax( "" ) ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_i" ) ) ) ) ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "x" ) ,new caterwaul.syntax( "x0" ) ) ,new caterwaul.syntax( "xi" ) ) ,new caterwaul.syntax( "xl" ) ) ,new caterwaul.syntax( "xr" ) ) ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "," ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "xs" ) ,new caterwaul.syntax( "0" ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "xi" ) ,new caterwaul.syntax( "0" ) ) ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "xl" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "xs" ) ,new caterwaul.syntax( "length" ) ) ) ) ,new caterwaul.syntax( "x_k_lq6ve5OyE4yDT_oYRjxWW1" ) ) ) ,new caterwaul.syntax( "<" ,new caterwaul.syntax( "xi" ) ,new caterwaul.syntax( "xl" ) ) ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "xi" ) ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "xs" ) ,new caterwaul.syntax( "xi" ) ) ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "x_k_lq6ve5OyE4yDT_oYRjxWW1" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "x" ) ,new caterwaul.syntax( "parse" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "s" ) ,new caterwaul.syntax( "i" ) ) ) ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "x_k_lq6ve5OyE4yDT_oYRjxWW1" ) ) ) ) ) ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "false" ) ) ) ) ) ) ) ,new caterwaul.syntax( "call" ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "this" ) ,new caterwaul.syntax( "_names" ) ) ) ) ) ) ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "," ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "parse" ) ,new caterwaul.syntax( "_parser" ) ) ) ) ) ,new caterwaul.syntax( "_alternatives" ) ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ) ) ;
