...
return result&& {v:f.call(result,result.v) ,i:result.i} } ) .call(this) } } ,ident=oneof( '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_' ) ,digit=oneof( '0123456789' ) ,hex=oneof( '0123456789ABCDEFabcdef' ) ,number=map(many(digit) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,end=function(p) {;
...
return no_pipes(p) } ,no_pipes=alt(map(join(term,no_pipes) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,term) ;
return alt(map(join(no_pipes,oneof( '|' ) ,toplevel) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,no_pipes,zero) } ) .call(this) ,term= (function() {var star=map(oneof( '*' ) ,node) ,plus=map(oneof( '+' ) ,node) ,question_mark=map(oneof( '?' ) ,node) ,repetition=alt(map(join(oneof( '{' ) ,number,oneof( '}' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,map(join(oneof( '{' ) ,number,oneof( ',' ) ,oneof( '}' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,map(join(oneof( '{' ) ,number,oneof( ',' ) ,number,oneof( '}' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ) ,modifier=alt(star,plus,repetition) ,non_greedy=oneof( '?' ) ,modifiers=alt(map(join(modifier,non_greedy) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,modifier,question_mark) ;
return alt(map(join(atom,modifiers) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,atom) } ) .call(this) ,atom= (function() {var positive_lookahead=map(join(string( '(?=' ) ,toplevel,string( ')' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,negative_lookahead=map(join(string( '(?!' ) ,toplevel,string( ')' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,forgetful_group=map(join(string( '(?:' ) ,toplevel,string( ')' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,group=map(join(string( '(' ) ,toplevel,string( ')' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,word=map(many(ident) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,character_class=function(p) {;
return character_class(p) } ,character_class= (function() {var each=alt(map(join(any(1) ,oneof( '-' ) ,any(1) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,map(join(oneof( '\\' ) ,any(1) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,map(not(1,oneof( ']' ) ) ,node) ) ;
return alt(map(join(each,character_class) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,each) } ) .call(this) ,character_not_in=map(join(string( '[^' ) ,character_class,string( ']' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,character_in=map(join(string( '[' ) ,character_class,string( ']' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,zero_width=map(oneof( '^$' ) ,node) ,escaped=map(join(oneof( '\\' ) ,oneof( 'BbWwSsDdfnrtv0*+.?|()[]{}\\$^' ) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,escaped_slash=map(string( '\\/' ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,control=map(join(string( '\\c' ) ,any(1) ) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,hex_code=map(join(string( '\\x' ) ,hex,hex) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,unicode=map(join(string( '\\u' ) ,hex,hex,hex,hex) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,backreference=function(p) {;
...
:single_digit_backreference(p) } ) .call(this, (map(join(oneof( '\\' ) ,digit,digit) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) (p) ) ) } ) .call(this) } ,dot=map(oneof( '.' ) ,node) ,other=map(not(1,oneof( ')|+*?{' ) ) ,node) ,maybe_word=settings.atom=== 'word' ?alt(word,other) 
:other,maybe_munch_spaces=settings.atom=== 'word' ?alt(many(oneof( ' ' ) ) ,zero) 
:zero,nontrivial_thing=alt(positive_lookahead,negative_lookahead,forgetful_group,group,character_not_in,character_in,zero_width,escaped,escaped_slash,control,hex_code,unicode,backreference,dot,maybe_word) ,base=alt(map(join(maybe_munch_spaces,nontrivial_thing,maybe_munch_spaces) , (function(_) {return function() {return unescape_string(this.as_escaped_string() ) } } ) ) ,nontrivial_thing) ;
